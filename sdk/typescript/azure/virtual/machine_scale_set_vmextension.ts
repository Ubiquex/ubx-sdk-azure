...
export interface MachineScaleSetVmextension_Properties_InstanceView {
  /** The virtual machine extension name. */
  name?: string | Computed<string>;
  /** The resource status information. */
  statuses?: MachineScaleSetVmextension_Properties_InstanceView_Statuses[] | Computed<MachineScaleSetVmextension_Properties_InstanceView_Statuses[]>;
  /** The resource status information. */
  substatuses?: MachineScaleSetVmextension_Properties_InstanceView_Statuses[] | Computed<MachineScaleSetVmextension_Properties_InstanceView_Statuses[]>;
...
export interface MachineScaleSetVmextension_Properties_ProtectedSettingsFromKeyVault_SourceVault {
  /** Resource Id */
...
export interface MachineScaleSetVmextension_Properties {
  ...
  instanceView?: MachineScaleSetVmextension_Properties_InstanceView | Computed<MachineScaleSetVmextension_Properties_InstanceView>;
  /** The extension can contain either protectedSettings or protectedSettingsFromKeyVault or no protected settings at all. */
  protectedSettings?: unknown | Computed<unknown>;
  /** Describes a reference to Key Vault Secret */
  protectedSettingsFromKeyVault?: MachineScaleSetVmextension_Properties_ProtectedSettingsFromKeyVault | Computed<MachineScaleSetVmextension_Properties_ProtectedSettingsFromKeyVault>;
...
const MachineScaleSetVmextension_Properties_InstanceView_StatusesFields: FieldMap = {
  code: "code",
...
const MachineScaleSetVmextension_Properties_InstanceViewFields: FieldMap = {
  name: "name",
  statuses: {
    wireName: "statuses",
    kind: "list",
...
const MachineScaleSetVmextension_Properties_ProtectedSettingsFromKeyVault_SourceVaultFields: FieldMap = {
  id: "id",
};

const MachineScaleSetVmextension_Properties_ProtectedSettingsFromKeyVaultFields: FieldMap = {
...
const MachineScaleSetVmextension_PropertiesFields: FieldMap = {
...
export interface MachineScaleSetVmextensionAttrs {
  ...
  name: string;
  /** Describes the properties of a Virtual Machine Extension. */
  properties: MachineScaleSetVmextension_Properties;
  /** Resource type */
  type: string;
}

export const MachineScaleSetVmextension: ResourceBinding<MachineScaleSetVmextensionConfig, MachineScaleSetVmextensionAttrs> = {
