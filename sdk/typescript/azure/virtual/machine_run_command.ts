...
const MachineRunCommand_Properties_ErrorBlobManagedIdentityFields: FieldMap = {
  clientId: "client_id",
  objectId: "object_id",
};

const MachineRunCommand_Properties_InstanceView_StatusesFields: FieldMap = {
  code: "code",
...
const MachineRunCommand_Properties_InstanceViewFields: FieldMap = {
  endTime: "end_time",
  error: "error",
...
const MachineRunCommand_Properties_ParametersFields: FieldMap = {
  name: "name",
  value: "value",
};

const MachineRunCommand_Properties_SourceFields: FieldMap = {
...
const MachineRunCommand_PropertiesFields: FieldMap = {
...
export interface MachineRunCommandConfig {
  ...
  properties?: MachineRunCommand_Properties | Computed<MachineRunCommand_Properties>;
}
