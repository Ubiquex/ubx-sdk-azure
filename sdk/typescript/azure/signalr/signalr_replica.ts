// Code generated by `ubx sdk gen` from azure_signalr_signalr_replica. DO NOT EDIT.
import type { Computed, FieldMap, ResourceBinding } from "@ubx/sdk";

export interface SignalrReplica_Properties {
...
export interface SignalrReplica_Sku {
...
const SignalrReplica_PropertiesFields: FieldMap = {
  provisioningState: "provisioning_state",
  regionEndpointEnabled: "region_endpoint_enabled",
  resourceStopped: "resource_stopped",
};

const SignalrReplica_SkuFields: FieldMap = {
  capacity: "capacity",
  family: "family",
  name: "name",
  size: "size",
...
export interface SignalrReplicaConfig {
  properties?: SignalrReplica_Properties | Computed<SignalrReplica_Properties>;
  /** The billing information of the resource. */
  sku?: SignalrReplica_Sku | Computed<SignalrReplica_Sku>;
}

export interface SignalrReplicaAttrs {
  properties: SignalrReplica_Properties;
  /** The billing information of the resource. */
  sku: SignalrReplica_Sku;
}

export const SignalrReplica: ResourceBinding<SignalrReplicaConfig, SignalrReplicaAttrs> = {
  wireType: "azure_signalr_signalr_replica",
  fields: {
    properties: {
      wireName: "properties",
      kind: "object",
      fields: SignalrReplica_PropertiesFields,
    },
    sku: {
      wireName: "sku",
      kind: "object",
      fields: SignalrReplica_SkuFields,
    },
  },
};
