...
export interface Cache_Properties_ExportPolicy_Rules {
...
export interface Cache_Properties_ExportPolicy {
  /** Export policy rule */
  rules?: Cache_Properties_ExportPolicy_Rules[] | Computed<Cache_Properties_ExportPolicy_Rules[]>;
}

export interface Cache_Properties_MountTargets {
  ipAddress?: string | Computed<string>;
  mountTargetId?: string | Computed<string>;
  smbServerFqdn?: string | Computed<string>;
}

export interface Cache_Properties_OriginClusterInformation {
...
export interface Cache_Properties_SmbSettings {
...
export interface Cache_Properties {
  ...
  exportPolicy?: Cache_Properties_ExportPolicy | Computed<Cache_Properties_ExportPolicy>;
  ...
  mountTargets?: Cache_Properties_MountTargets[] | Computed<Cache_Properties_MountTargets[]>;
  /** Stores the origin cluster information associated to a cache. */
  originClusterInformation: Cache_Properties_OriginClusterInformation | Computed<Cache_Properties_OriginClusterInformation>;
  ...
  smbSettings?: Cache_Properties_SmbSettings | Computed<Cache_Properties_SmbSettings>;
...
const Cache_Properties_ExportPolicy_RulesFields: FieldMap = {
...
const Cache_Properties_ExportPolicyFields: FieldMap = {
  rules: {
    wireName: "rules",
    kind: "list",
...
const Cache_Properties_MountTargetsFields: FieldMap = {
  ipAddress: "ip_address",
  mountTargetId: "mount_target_id",
  smbServerFqdn: "smb_server_fqdn",
};

const Cache_Properties_OriginClusterInformationFields: FieldMap = {
