...
export interface NetappVolume_Properties_DataProtection_Backup {
...
export interface NetappVolume_Properties_DataProtection_RansomwareProtection {
...
export interface NetappVolume_Properties_DataProtection_Replication_DestinationReplications {
...
export interface NetappVolume_Properties_DataProtection_Replication_RemotePath {
...
export interface NetappVolume_Properties_DataProtection_Replication {
  /** A list of destination replications */
  destinationReplications?: NetappVolume_Properties_DataProtection_Replication_DestinationReplications[] | Computed<NetappVolume_Properties_DataProtection_Replication_DestinationReplications[]>;
  ...
  remotePath?: NetappVolume_Properties_DataProtection_Replication_RemotePath | Computed<NetappVolume_Properties_DataProtection_Replication_RemotePath>;
...
export interface NetappVolume_Properties_DataProtection_Snapshot {
  /** Snapshot Policy ResourceId */
  snapshotPolicyId?: string | Computed<string>;
}

export interface NetappVolume_Properties_DataProtection_VolumeRelocation {
...
export interface NetappVolume_Properties_DataProtection {
  /** Volume Backup Properties */
  backup?: NetappVolume_Properties_DataProtection_Backup | Computed<NetappVolume_Properties_DataProtection_Backup>;
  /** Advanced Ransomware Protection reports (ARP) settings */
  ransomwareProtection?: NetappVolume_Properties_DataProtection_RansomwareProtection | Computed<NetappVolume_Properties_DataProtection_RansomwareProtection>;
  /** Replication properties */
  replication?: NetappVolume_Properties_DataProtection_Replication | Computed<NetappVolume_Properties_DataProtection_Replication>;
  /** Volume Snapshot Properties */
  snapshot?: NetappVolume_Properties_DataProtection_Snapshot | Computed<NetappVolume_Properties_DataProtection_Snapshot>;
  /** Volume relocation properties */
  volumeRelocation?: NetappVolume_Properties_DataProtection_VolumeRelocation | Computed<NetappVolume_Properties_DataProtection_VolumeRelocation>;
}

export interface NetappVolume_Properties_ExportPolicy_Rules {
...
export interface NetappVolume_Properties_ExportPolicy {
  /** Export policy rule */
  rules?: NetappVolume_Properties_ExportPolicy_Rules[] | Computed<NetappVolume_Properties_ExportPolicy_Rules[]>;
}

export interface NetappVolume_Properties_MountTargets {
...
export interface NetappVolume_Properties_PlacementRules {
  key?: string | Computed<string>;
  value?: string | Computed<string>;
}

export interface NetappVolume_Properties {
  ...
  dataProtection?: NetappVolume_Properties_DataProtection | Computed<NetappVolume_Properties_DataProtection>;
  ...
  exportPolicy?: NetappVolume_Properties_ExportPolicy | Computed<NetappVolume_Properties_ExportPolicy>;
  ...
  mountTargets?: NetappVolume_Properties_MountTargets[] | Computed<NetappVolume_Properties_MountTargets[]>;
  ...
  placementRules?: NetappVolume_Properties_PlacementRules[] | Computed<NetappVolume_Properties_PlacementRules[]>;
...
const NetappVolume_Properties_DataProtection_BackupFields: FieldMap = {
  backupPolicyId: "backup_policy_id",
  backupVaultId: "backup_vault_id",
  policyEnforced: "policy_enforced",
};

const NetappVolume_Properties_DataProtection_RansomwareProtectionFields: FieldMap = {
...
const NetappVolume_Properties_DataProtection_Replication_DestinationReplicationsFields: FieldMap = {
  region: "region",
...
const NetappVolume_Properties_DataProtection_Replication_RemotePathFields: FieldMap = {
  externalHostName: "external_host_name",
  serverName: "server_name",
  volumeName: "volume_name",
};

const NetappVolume_Properties_DataProtection_ReplicationFields: FieldMap = {
  destinationReplications: {
    wireName: "destination_replications",
    kind: "list",
    fields: NetappVolume_Properties_DataProtection_Replication_DestinationReplicationsFields,
  },
  ...
  remotePath: {
    ...
    kind: "object",
    fields: NetappVolume_Properties_DataProtection_Replication_RemotePathFields,
  },
...
const NetappVolume_Properties_DataProtection_SnapshotFields: FieldMap = {
  snapshotPolicyId: "snapshot_policy_id",
};

const NetappVolume_Properties_DataProtection_VolumeRelocationFields: FieldMap = {
  readyToBeFinalized: "ready_to_be_finalized",
  relocationRequested: "relocation_requested",
};

const NetappVolume_Properties_DataProtectionFields: FieldMap = {
  backup: {
    wireName: "backup",
    kind: "object",
    fields: NetappVolume_Properties_DataProtection_BackupFields,
  },
  ransomwareProtection: {
    wireName: "ransomware_protection",
    kind: "object",
    fields: NetappVolume_Properties_DataProtection_RansomwareProtectionFields,
  },
  replication: {
    wireName: "replication",
    kind: "object",
    fields: NetappVolume_Properties_DataProtection_ReplicationFields,
  },
  snapshot: {
    wireName: "snapshot",
    kind: "object",
    fields: NetappVolume_Properties_DataProtection_SnapshotFields,
  },
  volumeRelocation: {
    wireName: "volume_relocation",
    kind: "object",
    fields: NetappVolume_Properties_DataProtection_VolumeRelocationFields,
  },
};

const NetappVolume_Properties_ExportPolicy_RulesFields: FieldMap = {
...
const NetappVolume_Properties_ExportPolicyFields: FieldMap = {
  rules: {
    wireName: "rules",
    kind: "list",
    fields: NetappVolume_Properties_ExportPolicy_RulesFields,
  },
};

const NetappVolume_Properties_MountTargetsFields: FieldMap = {
...
const NetappVolume_Properties_PlacementRulesFields: FieldMap = {
  key: "key",
  value: "value",
};

const NetappVolume_PropertiesFields: FieldMap = {
  ...
  dataProtection: {
    ...
    kind: "object",
    fields: NetappVolume_Properties_DataProtectionFields,
  },
  ...
  exportPolicy: {
    ...
    kind: "object",
    fields: NetappVolume_Properties_ExportPolicyFields,
  },
  ...
  mountTargets: {
    ...
    kind: "list",
    fields: NetappVolume_Properties_MountTargetsFields,
  },
  ...
  placementRules: {
    ...
    kind: "list",
    fields: NetappVolume_Properties_PlacementRulesFields,
  },
...
export interface NetappVolumeConfig {
  ...
  /** Volume properties */
  properties: NetappVolume_Properties | Computed<NetappVolume_Properties>;
...
export interface NetappVolumeAttrs {
  ...
  etag: string;
  /** Volume properties */
  properties: NetappVolume_Properties;
  /** The availability zones. */
  zones: string[];
}

export const NetappVolume: ResourceBinding<NetappVolumeConfig, NetappVolumeAttrs> = {
  wireType: "azure_netapp_netapp_volume",
  fields: {
    etag: "etag",
    properties: {
      wireName: "properties",
      kind: "object",
      fields: NetappVolume_PropertiesFields,
    },
    zones: "zones",
  },
};
