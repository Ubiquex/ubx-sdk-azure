...
export interface SensitivitylabelsSensitivityLabel2_Properties {
...
const SensitivitylabelsSensitivityLabel2_PropertiesFields: FieldMap = {
...
export interface SensitivitylabelsSensitivityLabel2Attrs {
  /** Resource that manages the sensitivity label. */
  managedBy: string;
  /** Properties of a sensitivity label. */
  properties: SensitivitylabelsSensitivityLabel2_Properties;
}
