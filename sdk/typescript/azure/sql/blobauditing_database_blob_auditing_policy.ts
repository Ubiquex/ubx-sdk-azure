...
export interface BlobauditingDatabaseBlobAuditingPolicy_Properties {
...
const BlobauditingDatabaseBlobAuditingPolicy_PropertiesFields: FieldMap = {
...
export interface BlobauditingDatabaseBlobAuditingPolicyAttrs {
  ...
  kind: string;
  /** Properties of a database blob auditing policy. */
  properties: BlobauditingDatabaseBlobAuditingPolicy_Properties;
}
