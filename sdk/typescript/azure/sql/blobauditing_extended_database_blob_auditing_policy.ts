...
export interface BlobauditingExtendedDatabaseBlobAuditingPolicy_Properties {
...
const BlobauditingExtendedDatabaseBlobAuditingPolicy_PropertiesFields: FieldMap = {
...
export interface BlobauditingExtendedDatabaseBlobAuditingPolicyConfig {
  ...
  properties?: BlobauditingExtendedDatabaseBlobAuditingPolicy_Properties | Computed<BlobauditingExtendedDatabaseBlobAuditingPolicy_Properties>;
}

export interface BlobauditingExtendedDatabaseBlobAuditingPolicyAttrs {
  /** Properties of an extended database blob auditing policy. */
  properties: BlobauditingExtendedDatabaseBlobAuditingPolicy_Properties;
}

export const BlobauditingExtendedDatabaseBlobAuditingPolicy: ResourceBinding<BlobauditingExtendedDatabaseBlobAuditingPolicyConfig, BlobauditingExtendedDatabaseBlobAuditingPolicyAttrs> = {
  wireType: "azure_sql_blobauditing_extended_database_blob_auditing_policy",
  fields: {
    properties: {
      wireName: "properties",
      kind: "object",
      fields: BlobauditingExtendedDatabaseBlobAuditingPolicy_PropertiesFields,
    },
  },
};
