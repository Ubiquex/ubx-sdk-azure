...
export interface BlobauditingExtendedServerBlobAuditingPolicy_Properties {
...
const BlobauditingExtendedServerBlobAuditingPolicy_PropertiesFields: FieldMap = {
  auditActionsAndGroups: "audit_actions_and_groups",
  isAzureMonitorTargetEnabled: "is_azure_monitor_target_enabled",
  isDevopsAuditEnabled: "is_devops_audit_enabled",
...
export interface BlobauditingExtendedServerBlobAuditingPolicyConfig {
  ...
  properties?: BlobauditingExtendedServerBlobAuditingPolicy_Properties | Computed<BlobauditingExtendedServerBlobAuditingPolicy_Properties>;
}

export interface BlobauditingExtendedServerBlobAuditingPolicyAttrs {
  /** Properties of an extended server blob auditing policy. */
  properties: BlobauditingExtendedServerBlobAuditingPolicy_Properties;
}

export const BlobauditingExtendedServerBlobAuditingPolicy: ResourceBinding<BlobauditingExtendedServerBlobAuditingPolicyConfig, BlobauditingExtendedServerBlobAuditingPolicyAttrs> = {
