...
export interface SqlserverServerBlobAuditingPolicy_Properties {
...
const SqlserverServerBlobAuditingPolicy_PropertiesFields: FieldMap = {
...
export interface SqlserverServerBlobAuditingPolicyConfig {
  ...
  properties?: SqlserverServerBlobAuditingPolicy_Properties | Computed<SqlserverServerBlobAuditingPolicy_Properties>;
}

export interface SqlserverServerBlobAuditingPolicyAttrs {
  /** Properties of a server blob auditing policy. */
  properties: SqlserverServerBlobAuditingPolicy_Properties;
}

export const SqlserverServerBlobAuditingPolicy: ResourceBinding<SqlserverServerBlobAuditingPolicyConfig, SqlserverServerBlobAuditingPolicyAttrs> = {
  wireType: "azure_synapse_sqlserver_server_blob_auditing_policy",
  fields: {
    properties: {
      wireName: "properties",
      kind: "object",
      fields: SqlserverServerBlobAuditingPolicy_PropertiesFields,
    },
  },
};
