...
export interface SqlpoolSqlPoolBlobAuditingPolicy_Properties {
...
const SqlpoolSqlPoolBlobAuditingPolicy_PropertiesFields: FieldMap = {
...
export interface SqlpoolSqlPoolBlobAuditingPolicyAttrs {
  ...
  kind: string;
  /** Properties of a Sql pool blob auditing policy. */
  properties: SqlpoolSqlPoolBlobAuditingPolicy_Properties;
}
