...
class NetappBucket_Properties_AkvDetails_CertificateAkvDetails:
...
@dataclasses.dataclass
class NetappBucket_Properties_AkvDetails_CredentialsAkvDetails:
...
@dataclasses.dataclass
class NetappBucket_Properties_AkvDetails:
...
@dataclasses.dataclass
class NetappBucket_Properties_FileSystemUser_CifsUser:
    # The CIFS user's username
    username: Any = None

@dataclasses.dataclass
class NetappBucket_Properties_FileSystemUser_NfsUser:
    # The NFS user's GID
    group_id: Any = None
    # The NFS user's UID
    user_id: Any = None
...
@dataclasses.dataclass
class NetappBucket_Properties_FileSystemUser:
...
@dataclasses.dataclass
class NetappBucket_Properties_Server:
...
_NetappBucket_Properties_AkvDetails_CertificateAkvDetailsFields = {
...
_NetappBucket_Properties_AkvDetails_CredentialsAkvDetailsFields = {
...
_NetappBucket_Properties_AkvDetailsFields = {
    "certificate_akv_details": ubx.FieldSpec(
        wire_name="certificate_akv_details",
        kind="object",
        fields=_NetappBucket_Properties_AkvDetails_CertificateAkvDetailsFields,
    ),
    "credentials_akv_details": ubx.FieldSpec(
        wire_name="credentials_akv_details",
        kind="object",
        fields=_NetappBucket_Properties_AkvDetails_CredentialsAkvDetailsFields,
    ),
}

_NetappBucket_Properties_FileSystemUser_CifsUserFields = {
    "username": ubx.FieldSpec(wire_name="username"),
}

_NetappBucket_Properties_FileSystemUser_NfsUserFields = {
    "group_id": ubx.FieldSpec(wire_name="group_id"),
    "user_id": ubx.FieldSpec(wire_name="user_id"),
}

_NetappBucket_Properties_FileSystemUserFields = {
    "cifs_user": ubx.FieldSpec(
        wire_name="cifs_user",
        kind="object",
        fields=_NetappBucket_Properties_FileSystemUser_CifsUserFields,
    ),
    "nfs_user": ubx.FieldSpec(
        wire_name="nfs_user",
        kind="object",
        fields=_NetappBucket_Properties_FileSystemUser_NfsUserFields,
    ),
}

_NetappBucket_Properties_ServerFields = {
...
_NetappBucket_PropertiesFields = {
    "akv_details": ubx.FieldSpec(
        wire_name="akv_details",
        kind="object",
        fields=_NetappBucket_Properties_AkvDetailsFields,
    ),
    "file_system_user": ubx.FieldSpec(
        wire_name="file_system_user",
        kind="object",
        fields=_NetappBucket_Properties_FileSystemUserFields,
    ),
    ...
    "server": ubx.FieldSpec(
        wire_name="server",
        kind="object",
        fields=_NetappBucket_Properties_ServerFields,
    ),
    "status": ubx.FieldSpec(wire_name="status"),
}

@dataclasses.dataclass
class NetappBucketConfig:
    # Bucket resource properties
    properties: Any = None

@dataclasses.dataclass
class NetappBucketAttrs:
    # Bucket resource properties
    properties: Any = None

NetappBucket = ubx.ResourceBinding(
    wire_type="azure_netapp_netapp_bucket",
    fields={
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_NetappBucket_PropertiesFields,
        ),
    },
)
