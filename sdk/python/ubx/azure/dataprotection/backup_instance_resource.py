...
_BackupInstanceResource_Properties_DataSourceInfo_ResourcePropertiesFields = {
    "object_type": ubx.FieldSpec(wire_name="object_type"),
}

_BackupInstanceResource_Properties_DataSourceInfoFields = {
    ...
    "resource_properties": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BackupInstanceResource_Properties_DataSourceInfo_ResourcePropertiesFields,
    ),
    "resource_type": ubx.FieldSpec(wire_name="resource_type"),
    "resource_uri": ubx.FieldSpec(wire_name="resource_uri"),
}

_BackupInstanceResource_Properties_IdentityDetailsFields = {
...
_BackupInstanceResource_Properties_PolicyInfo_PolicyParameters_DataStoreParametersListFields = {
    "data_store_type": ubx.FieldSpec(wire_name="data_store_type"),
    "object_type": ubx.FieldSpec(wire_name="object_type"),
}

_BackupInstanceResource_Properties_PolicyInfo_PolicyParametersFields = {
    ...
    "data_store_parameters_list": ubx.FieldSpec(
        ...
        kind="list",
        fields=_BackupInstanceResource_Properties_PolicyInfo_PolicyParameters_DataStoreParametersListFields,
    ),
}

_BackupInstanceResource_Properties_PolicyInfoFields = {
    "policy_id": ubx.FieldSpec(wire_name="policy_id"),
    "policy_parameters": ubx.FieldSpec(
        wire_name="policy_parameters",
        kind="object",
        fields=_BackupInstanceResource_Properties_PolicyInfo_PolicyParametersFields,
    ),
    "policy_version": ubx.FieldSpec(wire_name="policy_version"),
}

_BackupInstanceResource_Properties_ProtectionErrorDetails_DetailsFields = {
}

_BackupInstanceResource_Properties_ProtectionErrorDetails_InnerErrorFields = {
...
_BackupInstanceResource_Properties_ProtectionErrorDetailsFields = {
    "code": ubx.FieldSpec(wire_name="code"),
    "details": ubx.FieldSpec(
        wire_name="details",
        kind="list",
        fields=_BackupInstanceResource_Properties_ProtectionErrorDetails_DetailsFields,
    ),
    "inner_error": ubx.FieldSpec(
        wire_name="inner_error",
        kind="object",
        fields=_BackupInstanceResource_Properties_ProtectionErrorDetails_InnerErrorFields,
    ),
...
_BackupInstanceResource_Properties_ProtectionStatusFields = {
    "error_details": ubx.FieldSpec(
        wire_name="error_details",
        kind="object",
        fields=_BackupInstanceResource_Properties_ProtectionErrorDetailsFields,
    ),
    "status": ubx.FieldSpec(wire_name="status"),
}

_BackupInstanceResource_PropertiesFields = {
    ...
    "data_source_info": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BackupInstanceResource_Properties_DataSourceInfoFields,
    ),
    ...
    "identity_details": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BackupInstanceResource_Properties_IdentityDetailsFields,
    ),
    "object_type": ubx.FieldSpec(wire_name="object_type"),
    "policy_info": ubx.FieldSpec(
        wire_name="policy_info",
        kind="object",
        fields=_BackupInstanceResource_Properties_PolicyInfoFields,
    ),
    ...
    "protection_status": ubx.FieldSpec(
        ...
        kind="object",
        fields=_BackupInstanceResource_Properties_ProtectionStatusFields,
    ),
...
BackupInstanceResource = ubx.ResourceBinding(
    wire_type="azure_dataprotection_backup_instance_resource",
    fields={
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_BackupInstanceResource_PropertiesFields,
        ),
