...
@dataclasses.dataclass
class SignalRresource_Identity:
...
@dataclasses.dataclass
class SignalRresource_Properties_Cors:
...
@dataclasses.dataclass
class SignalRresource_Properties_LiveTraceConfiguration:
...
@dataclasses.dataclass
class SignalRresource_Properties_NetworkAcls_PublicNetwork:
...
@dataclasses.dataclass
class SignalRresource_Properties_NetworkAcls:
...
@dataclasses.dataclass
class SignalRresource_Properties_ResourceLogConfiguration:
    # Gets or sets the list of category configurations.
    categories: Any = None

@dataclasses.dataclass
class SignalRresource_Properties_Serverless:
...
@dataclasses.dataclass
class SignalRresource_Properties_Tls:
...
@dataclasses.dataclass
class SignalRresource_Properties_Upstream:
    # Gets or sets the list of Upstream URL templates. Order matters, and the first matching template takes effects.
    templates: Any = None

@dataclasses.dataclass
class SignalRresource_Properties:
...
_SignalRresource_Identity_UserAssignedIdentitiesFields = {
    "client_id": ubx.FieldSpec(wire_name="client_id"),
    "principal_id": ubx.FieldSpec(wire_name="principal_id"),
}

_SignalRresource_IdentityFields = {
    "principal_id": ubx.FieldSpec(wire_name="principal_id"),
    ...
    "user_assigned_identities": ubx.FieldSpec(
        ...
        kind="map",
        fields=_SignalRresource_Identity_UserAssignedIdentitiesFields,
    ),
}

_SignalRresource_Properties_CorsFields = {
    "allowed_origins": ubx.FieldSpec(wire_name="allowed_origins"),
}

_SignalRresource_Properties_FeaturesFields = {
    "flag": ubx.FieldSpec(wire_name="flag"),
    "properties": ubx.FieldSpec(wire_name="properties"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_SignalRresource_Properties_LiveTraceConfiguration_CategoriesFields = {
    "enabled": ubx.FieldSpec(wire_name="enabled"),
    "name": ubx.FieldSpec(wire_name="name"),
}

_SignalRresource_Properties_LiveTraceConfigurationFields = {
    "categories": ubx.FieldSpec(
        wire_name="categories",
        kind="list",
        fields=_SignalRresource_Properties_LiveTraceConfiguration_CategoriesFields,
    ),
    "enabled": ubx.FieldSpec(wire_name="enabled"),
}

_SignalRresource_Properties_NetworkAcls_IpRulesFields = {
    "action": ubx.FieldSpec(wire_name="action"),
    "value": ubx.FieldSpec(wire_name="value"),
}

_SignalRresource_Properties_NetworkAcls_PrivateEndpointsFields = {
    "name": ubx.FieldSpec(wire_name="name"),
}

_SignalRresource_Properties_NetworkAcls_PublicNetworkFields = {
    "allow": ubx.FieldSpec(wire_name="allow"),
    "deny": ubx.FieldSpec(wire_name="deny"),
}

_SignalRresource_Properties_NetworkAclsFields = {
    "default_action": ubx.FieldSpec(wire_name="default_action"),
    "ip_rules": ubx.FieldSpec(
        wire_name="ip_rules",
        kind="list",
        fields=_SignalRresource_Properties_NetworkAcls_IpRulesFields,
    ),
    "private_endpoints": ubx.FieldSpec(
        wire_name="private_endpoints",
        kind="list",
        fields=_SignalRresource_Properties_NetworkAcls_PrivateEndpointsFields,
    ),
    "public_network": ubx.FieldSpec(
        wire_name="public_network",
        kind="object",
        fields=_SignalRresource_Properties_NetworkAcls_PublicNetworkFields,
    ),
}

_SignalRresource_Properties_PrivateEndpointConnections_Properties_PrivateEndpointFields = {
    "id": ubx.FieldSpec(wire_name="id"),
}

_SignalRresource_Properties_PrivateEndpointConnections_Properties_PrivateLinkServiceConnectionStateFields = {
    "actions_required": ubx.FieldSpec(wire_name="actions_required"),
    "description": ubx.FieldSpec(wire_name="description"),
    "status": ubx.FieldSpec(wire_name="status"),
}

_SignalRresource_Properties_PrivateEndpointConnections_PropertiesFields = {
    "group_ids": ubx.FieldSpec(wire_name="group_ids"),
    "private_endpoint": ubx.FieldSpec(
        wire_name="private_endpoint",
        kind="object",
        fields=_SignalRresource_Properties_PrivateEndpointConnections_Properties_PrivateEndpointFields,
    ),
    "private_link_service_connection_state": ubx.FieldSpec(
        wire_name="private_link_service_connection_state",
        kind="object",
        fields=_SignalRresource_Properties_PrivateEndpointConnections_Properties_PrivateLinkServiceConnectionStateFields,
    ),
    "provisioning_state": ubx.FieldSpec(wire_name="provisioning_state"),
}

_SignalRresource_Properties_PrivateEndpointConnectionsFields = {
    "properties": ubx.FieldSpec(
        wire_name="properties",
        kind="object",
        fields=_SignalRresource_Properties_PrivateEndpointConnections_PropertiesFields,
    ),
}

_SignalRresource_Properties_ResourceLogConfigurationFields = {
    "categories": ubx.FieldSpec(
        wire_name="categories",
        kind="list",
        fields=_SignalRresource_Properties_LiveTraceConfiguration_CategoriesFields,
...
_SignalRresource_Properties_ServerlessFields = {
    "connection_timeout_in_seconds": ubx.FieldSpec(wire_name="connection_timeout_in_seconds"),
}

_SignalRresource_Properties_SharedPrivateLinkResources_PropertiesFields = {
...
_SignalRresource_Properties_SharedPrivateLinkResourcesFields = {
    "properties": ubx.FieldSpec(
        wire_name="properties",
        kind="object",
        fields=_SignalRresource_Properties_SharedPrivateLinkResources_PropertiesFields,
    ),
}

_SignalRresource_Properties_TlsFields = {
    "client_cert_enabled": ubx.FieldSpec(wire_name="client_cert_enabled"),
}

_SignalRresource_Properties_Upstream_Templates_Auth_ManagedIdentityFields = {
    "resource": ubx.FieldSpec(wire_name="resource"),
}

_SignalRresource_Properties_Upstream_Templates_AuthFields = {
    "managed_identity": ubx.FieldSpec(
        wire_name="managed_identity",
        kind="object",
        fields=_SignalRresource_Properties_Upstream_Templates_Auth_ManagedIdentityFields,
    ),
    "type": ubx.FieldSpec(wire_name="type"),
}

_SignalRresource_Properties_Upstream_TemplatesFields = {
    "auth": ubx.FieldSpec(
        wire_name="auth",
        kind="object",
        fields=_SignalRresource_Properties_Upstream_Templates_AuthFields,
    ),
...
_SignalRresource_Properties_UpstreamFields = {
    "templates": ubx.FieldSpec(
        wire_name="templates",
        kind="list",
        fields=_SignalRresource_Properties_Upstream_TemplatesFields,
    ),
}

_SignalRresource_PropertiesFields = {
    "cors": ubx.FieldSpec(
        wire_name="cors",
        kind="object",
        fields=_SignalRresource_Properties_CorsFields,
    ),
    ...
    "features": ubx.FieldSpec(
        wire_name="features",
        kind="list",
        fields=_SignalRresource_Properties_FeaturesFields,
    ),
    ...
    "live_trace_configuration": ubx.FieldSpec(
        ...
        kind="object",
        fields=_SignalRresource_Properties_LiveTraceConfigurationFields,
    ),
    "network_acls": ubx.FieldSpec(
        wire_name="network_acls",
        kind="object",
        fields=_SignalRresource_Properties_NetworkAclsFields,
    ),
    "private_endpoint_connections": ubx.FieldSpec(
        wire_name="private_endpoint_connections",
        kind="list",
        fields=_SignalRresource_Properties_PrivateEndpointConnectionsFields,
    ),
    "provisioning_state": ubx.FieldSpec(wire_name="provisioning_state"),
    ...
    "resource_log_configuration": ubx.FieldSpec(
        ...
        kind="object",
        fields=_SignalRresource_Properties_ResourceLogConfigurationFields,
    ),
    ...
    "serverless": ubx.FieldSpec(
        ...
        kind="object",
        fields=_SignalRresource_Properties_ServerlessFields,
    ),
    "shared_private_link_resources": ubx.FieldSpec(
        wire_name="shared_private_link_resources",
        kind="list",
        fields=_SignalRresource_Properties_SharedPrivateLinkResourcesFields,
    ),
    "tls": ubx.FieldSpec(
        wire_name="tls",
        kind="object",
        fields=_SignalRresource_Properties_TlsFields,
    ),
    "upstream": ubx.FieldSpec(
        wire_name="upstream",
        kind="object",
        fields=_SignalRresource_Properties_UpstreamFields,
    ),
    "version": ubx.FieldSpec(wire_name="version"),
}

_SignalRresource_SkuFields = {
...
SignalRresource = ubx.ResourceBinding(
    ...
    fields={
        ...
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_SignalRresource_PropertiesFields,
        ),
        "sku": ubx.FieldSpec(
            wire_name="sku",
            kind="object",
