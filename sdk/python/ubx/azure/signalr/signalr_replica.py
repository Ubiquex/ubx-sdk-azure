...
class SignalrReplica_Properties:
...
_SignalrReplica_PropertiesFields = {
...
@dataclasses.dataclass
class SignalrReplicaConfig:
    properties: Any = None
    # The billing information of the resource.
    sku: Any = None

@dataclasses.dataclass
class SignalrReplicaAttrs:
    properties: Any = None
    # The billing information of the resource.
    sku: Any = None

SignalrReplica = ubx.ResourceBinding(
    wire_type="azure_signalr_signalr_replica",
    fields={
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_SignalrReplica_PropertiesFields,
        ),
        "sku": ubx.FieldSpec(
            wire_name="sku",
            kind="object",
            fields=_SignalrReplica_SkuFields,
        ),
    },
)
