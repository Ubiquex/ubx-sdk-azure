...
class ApimapisPolicie_Properties_WsdlSelector:
...
_ApimapisPolicie_PropertiesFields = {
    ...
    "wsdl_selector": ubx.FieldSpec(
        ...
        kind="object",
        fields=_ApimapisPolicie_Properties_WsdlSelectorFields,
    ),
}
...
ApimapisPolicie = ubx.ResourceBinding(
    wire_type="azure_apimanagement_apimapis_policie",
    fields={
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_ApimapisPolicie_PropertiesFields,
        ),
    },
)
