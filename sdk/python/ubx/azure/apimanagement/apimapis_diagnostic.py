...
class ApimapisDiagnostic_Properties_WsdlSelector:
...
@dataclasses.dataclass
class ApimapisDiagnostic_Properties:
...
_ApimapisDiagnostic_PropertiesFields = {
    ...
    "wsdl_selector": ubx.FieldSpec(
        ...
        kind="object",
        fields=_ApimapisDiagnostic_Properties_WsdlSelectorFields,
    ),
}

@dataclasses.dataclass
class ApimapisDiagnosticConfig:
    # API Create or Update Properties.
    properties: Any = None

@dataclasses.dataclass
class ApimapisDiagnosticAttrs:
    # API Create or Update Properties.
    properties: Any = None

ApimapisDiagnostic = ubx.ResourceBinding(
    wire_type="azure_apimanagement_apimapis_diagnostic",
    fields={
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_ApimapisDiagnostic_PropertiesFields,
        ),
    },
)
