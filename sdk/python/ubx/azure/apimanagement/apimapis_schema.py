...
class ApimapisSchema_Properties_WsdlSelector:
...
@dataclasses.dataclass
class ApimapisSchema_Properties:
...
_ApimapisSchema_PropertiesFields = {
    ...
    "wsdl_selector": ubx.FieldSpec(
        ...
        kind="object",
        fields=_ApimapisSchema_Properties_WsdlSelectorFields,
    ),
}

@dataclasses.dataclass
class ApimapisSchemaConfig:
    # API Create or Update Properties.
    properties: Any = None

@dataclasses.dataclass
class ApimapisSchemaAttrs:
    # API Create or Update Properties.
    properties: Any = None

ApimapisSchema = ubx.ResourceBinding(
    wire_type="azure_apimanagement_apimapis_schema",
    fields={
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_ApimapisSchema_PropertiesFields,
        ),
    },
)
