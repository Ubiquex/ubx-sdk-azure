...
class ApimapisIssue_Properties_WsdlSelector:
...
@dataclasses.dataclass
class ApimapisIssue_Properties:
...
_ApimapisIssue_PropertiesFields = {
    ...
    "wsdl_selector": ubx.FieldSpec(
        ...
        kind="object",
        fields=_ApimapisIssue_Properties_WsdlSelectorFields,
    ),
}
...
ApimapisIssue = ubx.ResourceBinding(
    wire_type="azure_apimanagement_apimapis_issue",
    fields={
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_ApimapisIssue_PropertiesFields,
        ),
    },
)
