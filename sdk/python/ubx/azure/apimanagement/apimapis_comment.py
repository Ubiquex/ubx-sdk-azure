...
class ApimapisComment_Properties_WsdlSelector:
...
@dataclasses.dataclass
class ApimapisComment_Properties:
...
_ApimapisComment_PropertiesFields = {
    ...
    "wsdl_selector": ubx.FieldSpec(
        ...
        kind="object",
        fields=_ApimapisComment_Properties_WsdlSelectorFields,
    ),
}

@dataclasses.dataclass
class ApimapisCommentConfig:
    # API Create or Update Properties.
    properties: Any = None

@dataclasses.dataclass
class ApimapisCommentAttrs:
    # API Create or Update Properties.
    properties: Any = None

ApimapisComment = ubx.ResourceBinding(
    wire_type="azure_apimanagement_apimapis_comment",
    fields={
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_ApimapisComment_PropertiesFields,
        ),
    },
)
