...
_ApimworkspacesApiContract2_PropertiesFields = {
    ...
    "wsdl_selector": ubx.FieldSpec(
        ...
        kind="object",
        fields=_ApimworkspacesApiContract2_Properties_WsdlSelectorFields,
    ),
}

@dataclasses.dataclass
class ApimworkspacesApiContract2Config:
    # API Create or Update Properties.
    properties: Any = None

@dataclasses.dataclass
class ApimworkspacesApiContract2Attrs:
    # API Create or Update Properties.
    properties: Any = None

ApimworkspacesApiContract2 = ubx.ResourceBinding(
    wire_type="azure_apimanagement_apimworkspaces_api_contract_2",
    fields={
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_ApimworkspacesApiContract2_PropertiesFields,
        ),
    },
)
