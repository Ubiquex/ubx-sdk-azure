...
class ApimapisTagDescription_Properties_WsdlSelector:
...
@dataclasses.dataclass
class ApimapisTagDescription_Properties:
...
_ApimapisTagDescription_PropertiesFields = {
    ...
    "wsdl_selector": ubx.FieldSpec(
        ...
        kind="object",
        fields=_ApimapisTagDescription_Properties_WsdlSelectorFields,
    ),
}

@dataclasses.dataclass
class ApimapisTagDescriptionConfig:
    # API Create or Update Properties.
    properties: Any = None

@dataclasses.dataclass
class ApimapisTagDescriptionAttrs:
    # API Create or Update Properties.
    properties: Any = None

ApimapisTagDescription = ubx.ResourceBinding(
    wire_type="azure_apimanagement_apimapis_tag_description",
    fields={
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_ApimapisTagDescription_PropertiesFields,
        ),
    },
)
