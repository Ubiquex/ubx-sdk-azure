...
class ApimapisRelease_Properties_WsdlSelector:
...
@dataclasses.dataclass
class ApimapisRelease_Properties:
...
_ApimapisRelease_PropertiesFields = {
    ...
    "wsdl_selector": ubx.FieldSpec(
        ...
        kind="object",
        fields=_ApimapisRelease_Properties_WsdlSelectorFields,
    ),
}

@dataclasses.dataclass
class ApimapisReleaseConfig:
    # API Create or Update Properties.
    properties: Any = None

@dataclasses.dataclass
class ApimapisReleaseAttrs:
    # API Create or Update Properties.
    properties: Any = None

ApimapisRelease = ubx.ResourceBinding(
    wire_type="azure_apimanagement_apimapis_release",
    fields={
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_ApimapisRelease_PropertiesFields,
        ),
    },
)
