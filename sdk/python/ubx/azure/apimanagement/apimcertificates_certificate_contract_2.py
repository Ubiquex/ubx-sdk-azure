...
@dataclasses.dataclass
class ApimcertificatesCertificateContract2Config:
    # Parameters supplied to the CreateOrUpdate certificate operation.
    properties: Any = None

@dataclasses.dataclass
class ApimcertificatesCertificateContract2Attrs:
    # Parameters supplied to the CreateOrUpdate certificate operation.
    properties: Any = None

ApimcertificatesCertificateContract2 = ubx.ResourceBinding(
    wire_type="azure_apimanagement_apimcertificates_certificate_contract_2",
    fields={
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_ApimcertificatesCertificateContract2_PropertiesFields,
        ),
    },
)
