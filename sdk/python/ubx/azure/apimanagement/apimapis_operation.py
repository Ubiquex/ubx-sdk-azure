...
class ApimapisOperation_Properties_WsdlSelector:
...
@dataclasses.dataclass
class ApimapisOperation_Properties:
...
_ApimapisOperation_PropertiesFields = {
    ...
    "wsdl_selector": ubx.FieldSpec(
        ...
        kind="object",
        fields=_ApimapisOperation_Properties_WsdlSelectorFields,
    ),
}
...
ApimapisOperation = ubx.ResourceBinding(
    wire_type="azure_apimanagement_apimapis_operation",
    fields={
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_ApimapisOperation_PropertiesFields,
        ),
    },
)
