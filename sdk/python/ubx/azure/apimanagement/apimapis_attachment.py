...
class ApimapisAttachment_Properties_WsdlSelector:
...
@dataclasses.dataclass
class ApimapisAttachment_Properties:
...
_ApimapisAttachment_PropertiesFields = {
    ...
    "wsdl_selector": ubx.FieldSpec(
        ...
        kind="object",
        fields=_ApimapisAttachment_Properties_WsdlSelectorFields,
    ),
}

@dataclasses.dataclass
class ApimapisAttachmentConfig:
    # API Create or Update Properties.
    properties: Any = None

@dataclasses.dataclass
class ApimapisAttachmentAttrs:
    # API Create or Update Properties.
    properties: Any = None

ApimapisAttachment = ubx.ResourceBinding(
    wire_type="azure_apimanagement_apimapis_attachment",
    fields={
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_ApimapisAttachment_PropertiesFields,
        ),
    },
)
