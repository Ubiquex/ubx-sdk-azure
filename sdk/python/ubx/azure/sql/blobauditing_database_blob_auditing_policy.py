...
class BlobauditingDatabaseBlobAuditingPolicy_Properties:
...
_BlobauditingDatabaseBlobAuditingPolicy_PropertiesFields = {
...
@dataclasses.dataclass
class BlobauditingDatabaseBlobAuditingPolicyAttrs:
    # Resource kind.
    kind: Any = None
    # Properties of a database blob auditing policy.
    properties: Any = None
...
BlobauditingDatabaseBlobAuditingPolicy = ubx.ResourceBinding(
    ...
    fields={
        "properties": ubx.FieldSpec(
            ...
            kind="object",
            fields=_BlobauditingDatabaseBlobAuditingPolicy_PropertiesFields,
        ),
    },
)
