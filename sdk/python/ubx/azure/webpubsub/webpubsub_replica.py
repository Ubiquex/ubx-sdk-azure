...
class WebpubsubReplica_Properties:
...
_WebpubsubReplica_PropertiesFields = {
...
@dataclasses.dataclass
class WebpubsubReplicaConfig:
    properties: Any = None
    # The billing information of the resource.
    sku: Any = None

@dataclasses.dataclass
class WebpubsubReplicaAttrs:
    properties: Any = None
    # The billing information of the resource.
    sku: Any = None

WebpubsubReplica = ubx.ResourceBinding(
    wire_type="azure_webpubsub_webpubsub_replica",
    fields={
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_WebpubsubReplica_PropertiesFields,
        ),
        "sku": ubx.FieldSpec(
            wire_name="sku",
            kind="object",
            fields=_WebpubsubReplica_SkuFields,
        ),
    },
)
