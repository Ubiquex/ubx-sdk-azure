...
class OpenapiDscNodeReportListResult_Value_Errors:
    error_code: Any = None
...
@dataclasses.dataclass
class OpenapiDscNodeReportListResult_Value_MetaConfiguration:
...
@dataclasses.dataclass
class OpenapiDscNodeReportListResult_Value_Resources_DependsOn:
    resource_id: Any = None

@dataclasses.dataclass
class OpenapiDscNodeReportListResult_Value_Resources:
    depends_on: Any = None
...
@dataclasses.dataclass
class OpenapiDscNodeReportListResult_Value:
...
@dataclasses.dataclass
class OpenapiDscNodeReportListResultConfig:
    automation_account_name: Any = None
    node_id: Any = None

@dataclasses.dataclass
class OpenapiDscNodeReportListResultAttrs:
    automation_account_name: Any = None
...
OpenapiDscNodeReportListResult = ubx.DataSourceBinding(
    wire_type="azure_automation_openapi_dsc_node_report_list_result",
    fields={
