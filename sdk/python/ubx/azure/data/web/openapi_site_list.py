...
class OpenapiSiteList_Value_ExtendedLocation:
    name: Any = None
    type: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Identity_UserAssignedIdentities:
    client_id: Any = None
    principal_id: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Identity:
    principal_id: Any = None
    tenant_id: Any = None
    type: Any = None
...
@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_AiIntegration_Mcp_Servers:
...
@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_AiIntegration_Mcp:
    servers: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_AiIntegration_SiteAuth:
    audience: Any = None
    issuer: Any = None
    jwks_uri: Any = None
    scopes: Any = None
...
@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_AiIntegration:
    api_spec_path: Any = None
    mcp: Any = None
    site_auth: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_CloningInfo:
...
@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_DaprConfig:
    app_id: Any = None
    app_port: Any = None
...
@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_DnsConfiguration:
...
@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_FunctionAppConfig_Deployment_Storage_Authentication:
    storage_account_connection_string_name: Any = None
    type: Any = None
    user_assigned_identity_resource_id: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_FunctionAppConfig_Deployment_Storage:
    authentication: Any = None
    type: Any = None
    value: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_FunctionAppConfig_Deployment:
    storage: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_FunctionAppConfig_Runtime:
    name: Any = None
    version: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_FunctionAppConfig_ScaleAndConcurrency_AlwaysReady:
    instance_count: Any = None
    name: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_FunctionAppConfig_ScaleAndConcurrency_Triggers_Http:
    per_instance_concurrency: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_FunctionAppConfig_ScaleAndConcurrency_Triggers:
    http: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_FunctionAppConfig_ScaleAndConcurrency:
...
@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_FunctionAppConfig_SiteUpdateStrategy:
    type: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_FunctionAppConfig:
    deployment: Any = None
    runtime: Any = None
...
@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_HostNameSslStates:
    host_type: Any = None
    name: Any = None
    ssl_state: Any = None
    thumbprint: Any = None
...
@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_HostingEnvironmentProfile:
    id: Any = None
    name: Any = None
    type: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_OutboundVnetRouting:
...
@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_ResourceConfig:
    cpu: Any = None
    memory: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_SiteConfig_ApiDefinition:
    url: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_SiteConfig_ApiManagementConfig:
    id: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_SiteConfig_AppSettings:
    name: Any = None
    value: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_SiteConfig_AutoHealRules_Actions_CustomAction:
    exe: Any = None
    parameters: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_SiteConfig_AutoHealRules_Actions:
    action_type: Any = None
    custom_action: Any = None
    min_process_execution_time: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_SiteConfig_AutoHealRules_Triggers_Requests:
    count: Any = None
    time_interval: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_SiteConfig_AutoHealRules_Triggers_SlowRequests:
    count: Any = None
    path: Any = None
    time_interval: Any = None
    time_taken: Any = None
...
@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_SiteConfig_AutoHealRules_Triggers_StatusCodes:
    count: Any = None
    path: Any = None
    status: Any = None
    sub_status: Any = None
...
@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_SiteConfig_AutoHealRules_Triggers_StatusCodesRange:
    count: Any = None
    path: Any = None
...
@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_SiteConfig_AutoHealRules_Triggers:
...
@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_SiteConfig_AutoHealRules:
    actions: Any = None
    triggers: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_SiteConfig_AzureStorageAccounts:
    access_key: Any = None
...
@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_SiteConfig_ConnectionStrings:
    connection_string: Any = None
    name: Any = None
    type: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_SiteConfig_Cors:
    allowed_origins: Any = None
    support_credentials: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_SiteConfig_Experiments_RampUpRules:
...
@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_SiteConfig_Experiments:
    ramp_up_rules: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_SiteConfig_HandlerMappings:
    arguments: Any = None
    extension: Any = None
    script_processor: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_SiteConfig_IpSecurityRestrictions:
    action: Any = None
    description: Any = None
    headers: Any = None
    ip_address: Any = None
...
@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_SiteConfig_Limits:
    max_disk_size_in_mb: Any = None
    max_memory_in_mb: Any = None
    max_percentage_cpu: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_SiteConfig_MachineKey:
    decryption: Any = None
...
@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_SiteConfig_Push_Properties:
...
@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_SiteConfig_Push:
    properties: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_SiteConfig_VirtualApplications_VirtualDirectories:
    physical_path: Any = None
    virtual_path: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_SiteConfig_VirtualApplications:
    physical_path: Any = None
...
@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_SiteConfig:
...
@dataclasses.dataclass
class OpenapiSiteList_Value_Properties_SlotSwapStatus:
    destination_slot_name: Any = None
    source_slot_name: Any = None
    timestamp_utc: Any = None

@dataclasses.dataclass
class OpenapiSiteList_Value_Properties:
...
@dataclasses.dataclass
class OpenapiSiteListConfig:
    pass

@dataclasses.dataclass
class OpenapiSiteListAttrs:
    # The link to the next page of items
    next_link: Any = None
    # The Site items on this page
    value: Any = None

OpenapiSiteList = ubx.DataSourceBinding(
    wire_type="azure_web_openapi_site_list",
    fields={
    },
)
