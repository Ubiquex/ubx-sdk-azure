...
@dataclasses.dataclass
class OpenapiWorkspaceList_Value_Properties_Failover:
    last_modified_date: Any = None
    state: Any = None

@dataclasses.dataclass
class OpenapiWorkspaceList_Value_Properties_Features:
...
@dataclasses.dataclass
class OpenapiWorkspaceList_Value_Properties_PrivateLinkScopedResources:
    resource_id: Any = None
    scope_id: Any = None

@dataclasses.dataclass
class OpenapiWorkspaceList_Value_Properties_Replication:
...
@dataclasses.dataclass
class OpenapiWorkspaceList_Value_Properties_Sku:
    capacity_reservation_level: Any = None
    last_sku_update: Any = None
    name: Any = None

@dataclasses.dataclass
class OpenapiWorkspaceList_Value_Properties_WorkspaceCapping:
...
OpenapiWorkspaceList = ubx.DataSourceBinding(
    wire_type="azure_operationalinsights_openapi_workspace_list",
    fields={
    },
)
