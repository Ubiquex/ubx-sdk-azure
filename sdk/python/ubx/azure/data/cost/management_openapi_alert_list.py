...
class ManagementOpenapiAlertList_Value_Properties_Definition:
    category: Any = None
    criteria: Any = None
    type: Any = None

@dataclasses.dataclass
class ManagementOpenapiAlertList_Value_Properties_Details:
    amount: Any = None
...
@dataclasses.dataclass
class ManagementOpenapiAlertList_Value_Properties:
    close_time: Any = None
...
@dataclasses.dataclass
class ManagementOpenapiAlertList_Value:
    e_tag: Any = None
    properties: Any = None

@dataclasses.dataclass
class ManagementOpenapiAlertListConfig:
    external_cloud_provider_id: Any = None
    external_cloud_provider_type: Any = None

@dataclasses.dataclass
class ManagementOpenapiAlertListAttrs:
    external_cloud_provider_id: Any = None
    external_cloud_provider_type: Any = None
...
ManagementOpenapiAlertList = ubx.DataSourceBinding(
    wire_type="azure_cost_management_openapi_alert_list",
    fields={
