...
class OpenapiTransaction_Value_Properties_AzureCreditApplied:
    currency: Any = None
    value: Any = None

@dataclasses.dataclass
class OpenapiTransaction_Value_Properties_RefundTransactionDetails:
    amount_refunded: Any = None
    amount_requested: Any = None
    refund_operation_id: Any = None

@dataclasses.dataclass
class OpenapiTransaction_Value_Properties:
...
@dataclasses.dataclass
class OpenapiTransaction_Value:
    properties: Any = None

@dataclasses.dataclass
class OpenapiTransactionConfig:
...
OpenapiTransaction = ubx.DataSourceBinding(
    wire_type="azure_billing_openapi_transaction",
    fields={
