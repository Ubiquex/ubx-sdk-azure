...
class OpenapiCustomerList_Value_Properties_EnabledAzurePlans:
    product_id: Any = None
    sku_description: Any = None
    sku_id: Any = None

@dataclasses.dataclass
class OpenapiCustomerList_Value_Properties_Resellers:
    description: Any = None
    reseller_id: Any = None

@dataclasses.dataclass
class OpenapiCustomerList_Value_Properties:
...
@dataclasses.dataclass
class OpenapiCustomerList_Value:
    properties: Any = None
    tags: Any = None

@dataclasses.dataclass
class OpenapiCustomerListConfig:
...
@dataclasses.dataclass
class OpenapiCustomerListAttrs:
    billing_account_name: Any = None
    billing_profile_name: Any = None
    count: Any = None
    expand: Any = None
...
OpenapiCustomerList = ubx.DataSourceBinding(
    wire_type="azure_billing_openapi_customer_list",
    fields={
