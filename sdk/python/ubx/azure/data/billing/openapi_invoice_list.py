...
class OpenapiInvoiceList_Value_Properties_AmountDue:
    currency: Any = None
    value: Any = None

@dataclasses.dataclass
class OpenapiInvoiceList_Value_Properties_Documents:
...
@dataclasses.dataclass
class OpenapiInvoiceList_Value_Properties_FailedPayments:
    date: Any = None
    failed_payment_reason: Any = None

@dataclasses.dataclass
class OpenapiInvoiceList_Value_Properties_Payments:
    amount: Any = None
    date: Any = None
...
@dataclasses.dataclass
class OpenapiInvoiceList_Value_Properties_RebillDetails_RebillDetails:
    credit_note_document_id: Any = None
    invoice_document_id: Any = None
    rebill_details: Any = None

@dataclasses.dataclass
class OpenapiInvoiceList_Value_Properties_RebillDetails:
    credit_note_document_id: Any = None
    invoice_document_id: Any = None
    rebill_details: Any = None

@dataclasses.dataclass
class OpenapiInvoiceList_Value_Properties_RefundDetails:
...
@dataclasses.dataclass
class OpenapiInvoiceList_Value_Properties:
    amount_due: Any = None
...
@dataclasses.dataclass
class OpenapiInvoiceList_Value:
    properties: Any = None
    tags: Any = None

@dataclasses.dataclass
class OpenapiInvoiceListConfig:
    count: Any = None
    filter: Any = None
    order_by: Any = None
...
OpenapiInvoiceList = ubx.DataSourceBinding(
    wire_type="azure_billing_openapi_invoice_list",
    fields={
