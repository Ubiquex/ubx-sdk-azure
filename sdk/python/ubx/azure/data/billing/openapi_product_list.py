...
class OpenapiProductList_Value_Properties_LastCharge:
    currency: Any = None
    value: Any = None

@dataclasses.dataclass
class OpenapiProductList_Value_Properties_Reseller:
    description: Any = None
    reseller_id: Any = None

@dataclasses.dataclass
class OpenapiProductList_Value_Properties:
    auto_renew: Any = None
...
@dataclasses.dataclass
class OpenapiProductList_Value:
    properties: Any = None
    tags: Any = None

@dataclasses.dataclass
class OpenapiProductListConfig:
...
OpenapiProductList = ubx.DataSourceBinding(
    wire_type="azure_billing_openapi_product_list",
    fields={
