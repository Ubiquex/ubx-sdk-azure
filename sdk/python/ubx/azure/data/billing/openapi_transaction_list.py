...
class OpenapiTransactionList_Value_Properties_AzureCreditApplied:
    currency: Any = None
    value: Any = None

@dataclasses.dataclass
class OpenapiTransactionList_Value_Properties_RefundTransactionDetails:
    amount_refunded: Any = None
    amount_requested: Any = None
    refund_operation_id: Any = None

@dataclasses.dataclass
class OpenapiTransactionList_Value_Properties:
...
@dataclasses.dataclass
class OpenapiTransactionList_Value:
    properties: Any = None

@dataclasses.dataclass
class OpenapiTransactionListConfig:
...
@dataclasses.dataclass
class OpenapiTransactionListAttrs:
    billing_account_name: Any = None
    billing_profile_name: Any = None
    count: Any = None
    customer_name: Any = None
...
OpenapiTransactionList = ubx.DataSourceBinding(
    wire_type="azure_billing_openapi_transaction_list",
    fields={
