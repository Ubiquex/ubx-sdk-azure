...
class OpenapiBillingRoleAssignmentList_Value_Properties:
...
@dataclasses.dataclass
class OpenapiBillingRoleAssignmentList_Value:
    properties: Any = None
    tags: Any = None

@dataclasses.dataclass
class OpenapiBillingRoleAssignmentListConfig:
...
@dataclasses.dataclass
class OpenapiBillingRoleAssignmentListAttrs:
    billing_account_name: Any = None
    billing_profile_name: Any = None
    filter: Any = None
...
OpenapiBillingRoleAssignmentList = ubx.DataSourceBinding(
    wire_type="azure_billing_openapi_billing_role_assignment_list",
    fields={
