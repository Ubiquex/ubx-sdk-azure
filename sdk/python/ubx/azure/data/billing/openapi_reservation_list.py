...
class OpenapiReservationList_Summary:
...
@dataclasses.dataclass
class OpenapiReservationList_Value_Properties_AppliedScopeProperties:
...
@dataclasses.dataclass
class OpenapiReservationList_Value_Properties_ExtendedStatusInfo_Properties:
    subscription_id: Any = None

@dataclasses.dataclass
class OpenapiReservationList_Value_Properties_ExtendedStatusInfo:
    message: Any = None
    properties: Any = None
    status_code: Any = None

@dataclasses.dataclass
class OpenapiReservationList_Value_Properties_MergeProperties:
    merge_destination: Any = None
    merge_sources: Any = None

@dataclasses.dataclass
class OpenapiReservationList_Value_Properties_RenewProperties_BillingCurrencyTotal:
    amount: Any = None
    currency_code: Any = None

@dataclasses.dataclass
class OpenapiReservationList_Value_Properties_RenewProperties_PurchaseProperties_Properties_ReservedResourceProperties:
    instance_flexibility: Any = None

@dataclasses.dataclass
class OpenapiReservationList_Value_Properties_RenewProperties_PurchaseProperties_Properties:
...
@dataclasses.dataclass
class OpenapiReservationList_Value_Properties_RenewProperties_PurchaseProperties_Sku:
    name: Any = None

@dataclasses.dataclass
class OpenapiReservationList_Value_Properties_RenewProperties_PurchaseProperties:
    location: Any = None
    properties: Any = None
    sku: Any = None

@dataclasses.dataclass
class OpenapiReservationList_Value_Properties_RenewProperties:
    billing_currency_total: Any = None
    pricing_currency_total: Any = None
    purchase_properties: Any = None

@dataclasses.dataclass
class OpenapiReservationList_Value_Properties_SplitProperties:
    split_destinations: Any = None
    split_source: Any = None

@dataclasses.dataclass
class OpenapiReservationList_Value_Properties_SwapProperties:
    swap_destination: Any = None
    swap_source: Any = None

@dataclasses.dataclass
class OpenapiReservationList_Value_Properties_Utilization_Aggregates:
    grain: Any = None
    grain_unit: Any = None
    value: Any = None
    value_unit: Any = None
...
@dataclasses.dataclass
class OpenapiReservationList_Value_Properties_Utilization:
    aggregates: Any = None
    trend: Any = None

@dataclasses.dataclass
class OpenapiReservationList_Value_Properties:
    applied_scope_properties: Any = None
    applied_scope_type: Any = None
    applied_scopes: Any = None
    archived: Any = None
...
@dataclasses.dataclass
class OpenapiReservationList_Value:
    etag: Any = None
    location: Any = None
    properties: Any = None
    sku: Any = None
...
@dataclasses.dataclass
class OpenapiReservationListConfig:
...
@dataclasses.dataclass
class OpenapiReservationListAttrs:
    billing_account_name: Any = None
    billing_profile_name: Any = None
    filter: Any = None
...
OpenapiReservationList = ubx.DataSourceBinding(
    wire_type="azure_billing_openapi_reservation_list",
    fields={
