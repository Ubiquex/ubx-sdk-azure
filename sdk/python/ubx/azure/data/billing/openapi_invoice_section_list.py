...
class OpenapiInvoiceSectionList_Value_Properties:
...
@dataclasses.dataclass
class OpenapiInvoiceSectionList_Value:
    properties: Any = None
    tags: Any = None

@dataclasses.dataclass
class OpenapiInvoiceSectionListConfig:
...
@dataclasses.dataclass
class OpenapiInvoiceSectionListAttrs:
    billing_account_name: Any = None
    billing_profile_name: Any = None
    count: Any = None
    filter: Any = None
...
OpenapiInvoiceSectionList = ubx.DataSourceBinding(
    wire_type="azure_billing_openapi_invoice_section_list",
    fields={
