...
class OpenapiAgreementList_Value_Properties_BillingProfileInfo:
...
@dataclasses.dataclass
class OpenapiAgreementList_Value_Properties_Participants:
    email: Any = None
    status: Any = None
    status_date: Any = None

@dataclasses.dataclass
class OpenapiAgreementList_Value_Properties:
...
@dataclasses.dataclass
class OpenapiAgreementList_Value:
    properties: Any = None
    tags: Any = None

@dataclasses.dataclass
class OpenapiAgreementListConfig:
    billing_account_name: Any = None
    expand: Any = None

@dataclasses.dataclass
class OpenapiAgreementListAttrs:
    billing_account_name: Any = None
    expand: Any = None
...
OpenapiAgreementList = ubx.DataSourceBinding(
    wire_type="azure_billing_openapi_agreement_list",
    fields={
