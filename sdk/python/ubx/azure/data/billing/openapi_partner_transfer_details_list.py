...
class OpenapiPartnerTransferDetailsList_Value_Properties_DetailedTransferStatus_ErrorDetails:
    code: Any = None
    message: Any = None

@dataclasses.dataclass
class OpenapiPartnerTransferDetailsList_Value_Properties_DetailedTransferStatus:
...
@dataclasses.dataclass
class OpenapiPartnerTransferDetailsList_Value_Properties:
...
@dataclasses.dataclass
class OpenapiPartnerTransferDetailsList_Value:
    properties: Any = None
    tags: Any = None

@dataclasses.dataclass
class OpenapiPartnerTransferDetailsListConfig:
    billing_account_name: Any = None
    billing_profile_name: Any = None
    customer_name: Any = None

@dataclasses.dataclass
class OpenapiPartnerTransferDetailsListAttrs:
    billing_account_name: Any = None
    billing_profile_name: Any = None
    customer_name: Any = None
...
OpenapiPartnerTransferDetailsList = ubx.DataSourceBinding(
    wire_type="azure_billing_openapi_partner_transfer_details_list",
    fields={
