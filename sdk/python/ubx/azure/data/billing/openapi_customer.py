...
class OpenapiCustomer_Value_Properties_EnabledAzurePlans:
    product_id: Any = None
    sku_description: Any = None
    sku_id: Any = None

@dataclasses.dataclass
class OpenapiCustomer_Value_Properties_Resellers:
    description: Any = None
    reseller_id: Any = None

@dataclasses.dataclass
class OpenapiCustomer_Value_Properties:
