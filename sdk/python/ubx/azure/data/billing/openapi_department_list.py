...
class OpenapiDepartmentList_Value_Properties:
...
@dataclasses.dataclass
class OpenapiDepartmentList_Value:
    properties: Any = None
    tags: Any = None

@dataclasses.dataclass
class OpenapiDepartmentListConfig:
...
@dataclasses.dataclass
class OpenapiDepartmentListAttrs:
    billing_account_name: Any = None
    filter: Any = None
...
OpenapiDepartmentList = ubx.DataSourceBinding(
    wire_type="azure_billing_openapi_department_list",
    fields={
