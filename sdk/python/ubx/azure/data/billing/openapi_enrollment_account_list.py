...
class OpenapiEnrollmentAccountList_Value_Properties:
...
@dataclasses.dataclass
class OpenapiEnrollmentAccountList_Value:
    properties: Any = None
    tags: Any = None

@dataclasses.dataclass
class OpenapiEnrollmentAccountListConfig:
...
@dataclasses.dataclass
class OpenapiEnrollmentAccountListAttrs:
    billing_account_name: Any = None
    count: Any = None
    department_name: Any = None
    filter: Any = None
...
OpenapiEnrollmentAccountList = ubx.DataSourceBinding(
    wire_type="azure_billing_openapi_enrollment_account_list",
    fields={
