...
class OpenapiBillingSubscriptionList_Value_Properties_Beneficiary:
    object_id: Any = None
    tenant_id: Any = None

@dataclasses.dataclass
class OpenapiBillingSubscriptionList_Value_Properties_EnrollmentAccountSubscriptionDetails:
    enrollment_account_start_date: Any = None
    subscription_enrollment_account_status: Any = None

@dataclasses.dataclass
class OpenapiBillingSubscriptionList_Value_Properties_LastMonthCharges:
    currency: Any = None
    value: Any = None

@dataclasses.dataclass
class OpenapiBillingSubscriptionList_Value_Properties_NextBillingCycleDetails:
    billing_frequency: Any = None

@dataclasses.dataclass
class OpenapiBillingSubscriptionList_Value_Properties_RenewalTermDetails:
    billing_frequency: Any = None
    product_id: Any = None
...
@dataclasses.dataclass
class OpenapiBillingSubscriptionList_Value_Properties_Reseller:
    description: Any = None
    reseller_id: Any = None

@dataclasses.dataclass
class OpenapiBillingSubscriptionList_Value_Properties_SuspensionReasonDetails:
    effective_date: Any = None
    reason: Any = None

@dataclasses.dataclass
class OpenapiBillingSubscriptionList_Value_Properties_SystemOverrides:
    cancellation: Any = None
    cancellation_allowed_end_date: Any = None

@dataclasses.dataclass
class OpenapiBillingSubscriptionList_Value_Properties:
    auto_renew: Any = None
...
@dataclasses.dataclass
class OpenapiBillingSubscriptionList_Value:
    properties: Any = None
    tags: Any = None

@dataclasses.dataclass
class OpenapiBillingSubscriptionListConfig:
...
@dataclasses.dataclass
class OpenapiBillingSubscriptionListAttrs:
    billing_account_name: Any = None
    billing_profile_name: Any = None
    count: Any = None
    expand: Any = None
...
OpenapiBillingSubscriptionList = ubx.DataSourceBinding(
    wire_type="azure_billing_openapi_billing_subscription_list",
    fields={
