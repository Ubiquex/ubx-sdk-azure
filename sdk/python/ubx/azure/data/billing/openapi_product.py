...
class OpenapiProduct_Value_Properties_LastCharge:
    currency: Any = None
    value: Any = None

@dataclasses.dataclass
class OpenapiProduct_Value_Properties_Reseller:
    description: Any = None
    reseller_id: Any = None

@dataclasses.dataclass
class OpenapiProduct_Value_Properties:
    auto_renew: Any = None
...
OpenapiProduct = ubx.DataSourceBinding(
