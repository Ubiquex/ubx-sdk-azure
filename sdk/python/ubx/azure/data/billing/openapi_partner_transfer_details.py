...
class OpenapiPartnerTransferDetails_Value_Properties_DetailedTransferStatus_ErrorDetails:
    code: Any = None
    message: Any = None

@dataclasses.dataclass
class OpenapiPartnerTransferDetails_Value_Properties_DetailedTransferStatus:
...
@dataclasses.dataclass
class OpenapiPartnerTransferDetails_Value_Properties:
...
@dataclasses.dataclass
class OpenapiPartnerTransferDetails_Value:
    properties: Any = None
    tags: Any = None
...
OpenapiPartnerTransferDetails = ubx.DataSourceBinding(
