...
class ClientGroupList_Value_Properties:
    description: Any = None
    provisioning_state: Any = None
    query: Any = None

@dataclasses.dataclass
class ClientGroupList_Value_SystemData:
    created_at: Any = None
    created_by: Any = None
...
@dataclasses.dataclass
class ClientGroupList_Value:
    properties: Any = None
    system_data: Any = None

@dataclasses.dataclass
class ClientGroupListConfig:
...
ClientGroupList = ubx.DataSourceBinding(
    wire_type="azure_eventgrid_client_group_list",
    fields={
