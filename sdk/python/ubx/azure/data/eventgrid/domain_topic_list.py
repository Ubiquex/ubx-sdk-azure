...
class DomainTopicList_Value_Properties:
    provisioning_state: Any = None

@dataclasses.dataclass
class DomainTopicList_Value_SystemData:
    created_at: Any = None
    created_by: Any = None
...
@dataclasses.dataclass
class DomainTopicList_Value:
    properties: Any = None
    system_data: Any = None

@dataclasses.dataclass
class DomainTopicListConfig:
...
DomainTopicList = ubx.DataSourceBinding(
    wire_type="azure_eventgrid_domain_topic_list",
    fields={
