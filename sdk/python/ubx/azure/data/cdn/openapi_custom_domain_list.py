...
class OpenapiCustomDomainList_Value_Properties_CustomHttpsParameters:
    certificate_source: Any = None
    minimum_tls_version: Any = None
    protocol_type: Any = None

@dataclasses.dataclass
class OpenapiCustomDomainList_Value_Properties:
...
@dataclasses.dataclass
class OpenapiCustomDomainList_Value:
    properties: Any = None

@dataclasses.dataclass
class OpenapiCustomDomainListConfig:
    endpoint_name: Any = None
    profile_name: Any = None

@dataclasses.dataclass
class OpenapiCustomDomainListAttrs:
    endpoint_name: Any = None
...
OpenapiCustomDomainList = ubx.DataSourceBinding(
    wire_type="azure_cdn_openapi_custom_domain_list",
    fields={
