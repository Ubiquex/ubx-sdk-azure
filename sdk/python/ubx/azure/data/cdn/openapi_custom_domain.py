...
class OpenapiCustomDomain_Value_Properties_CustomHttpsParameters:
    certificate_source: Any = None
    minimum_tls_version: Any = None
    protocol_type: Any = None

@dataclasses.dataclass
class OpenapiCustomDomain_Value_Properties:
...
@dataclasses.dataclass
class OpenapiCustomDomain_Value:
    properties: Any = None
...
OpenapiCustomDomain = ubx.DataSourceBinding(
