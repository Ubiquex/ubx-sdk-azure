...
class IntegrationAccountSchema_Value_Properties_ContentLink_ContentHash:
    algorithm: Any = None
    value: Any = None

@dataclasses.dataclass
class IntegrationAccountSchema_Value_Properties_ContentLink:
...
@dataclasses.dataclass
class IntegrationAccountSchema_Value_Properties:
...
@dataclasses.dataclass
class IntegrationAccountSchema_Value:
    properties: Any = None
...
IntegrationAccountSchema = ubx.DataSourceBinding(
