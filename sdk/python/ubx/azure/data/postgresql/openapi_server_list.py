...
@dataclasses.dataclass
class OpenapiServerList_Value_Properties_AuthConfig:
...
@dataclasses.dataclass
class OpenapiServerList_Value_Properties_Cluster:
...
@dataclasses.dataclass
class OpenapiServerList_Value_Properties_Replica:
    capacity: Any = None
...
OpenapiServerList = ubx.DataSourceBinding(
    wire_type="azure_postgresql_openapi_server_list",
    fields={
    },
)
