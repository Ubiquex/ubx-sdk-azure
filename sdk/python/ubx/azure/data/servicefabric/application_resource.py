...
class ApplicationResource_Value_Identity_UserAssignedIdentities:
    client_id: Any = None
    principal_id: Any = None

@dataclasses.dataclass
class ApplicationResource_Value_Identity:
    principal_id: Any = None
    tenant_id: Any = None
    type: Any = None
...
@dataclasses.dataclass
class ApplicationResource_Value_Properties:
    provisioning_state: Any = None
    type_name: Any = None

@dataclasses.dataclass
class ApplicationResource_Value:
    identity: Any = None
    properties: Any = None
...
ApplicationResource = ubx.DataSourceBinding(
