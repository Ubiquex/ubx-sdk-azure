...
class ComponentsApplicationInsightsComponent_Value_Properties_PrivateLinkScopedResources:
    resource_id: Any = None
    scope_id: Any = None

@dataclasses.dataclass
class ComponentsApplicationInsightsComponent_Value_Properties:
    app_id: Any = None
...
@dataclasses.dataclass
class ComponentsApplicationInsightsComponent_Value:
    kind: Any = None
    properties: Any = None
...
ComponentsApplicationInsightsComponent = ubx.DataSourceBinding(
