...
class ReservationList_Value_Properties_AppliedScopeProperties:
...
@dataclasses.dataclass
class ReservationList_Value_Properties_ExtendedStatusInfo:
    message: Any = None
    status_code: Any = None

@dataclasses.dataclass
class ReservationList_Value_Properties_MergeProperties:
    merge_destination: Any = None
    merge_sources: Any = None

@dataclasses.dataclass
class ReservationList_Value_Properties_RenewProperties_BillingCurrencyTotal:
    amount: Any = None
    currency_code: Any = None

@dataclasses.dataclass
class ReservationList_Value_Properties_RenewProperties_PurchaseProperties_Properties_ReservedResourceProperties:
    instance_flexibility: Any = None

@dataclasses.dataclass
class ReservationList_Value_Properties_RenewProperties_PurchaseProperties_Properties:
...
@dataclasses.dataclass
class ReservationList_Value_Properties_RenewProperties_PurchaseProperties_Sku:
    name: Any = None

@dataclasses.dataclass
class ReservationList_Value_Properties_RenewProperties_PurchaseProperties:
    location: Any = None
    properties: Any = None
    sku: Any = None

@dataclasses.dataclass
class ReservationList_Value_Properties_RenewProperties:
    billing_currency_total: Any = None
    pricing_currency_total: Any = None
    purchase_properties: Any = None

@dataclasses.dataclass
class ReservationList_Value_Properties_SplitProperties:
    split_destinations: Any = None
    split_source: Any = None

@dataclasses.dataclass
class ReservationList_Value_Properties_SwapProperties:
    swap_destination: Any = None
    swap_source: Any = None

@dataclasses.dataclass
class ReservationList_Value_Properties_Utilization_Aggregates:
    grain: Any = None
    grain_unit: Any = None
    value: Any = None
    value_unit: Any = None
...
@dataclasses.dataclass
class ReservationList_Value_Properties_Utilization:
    aggregates: Any = None
    trend: Any = None
...
ReservationList = ubx.DataSourceBinding(
    wire_type="azure_reservations_reservation_list",
    fields={
