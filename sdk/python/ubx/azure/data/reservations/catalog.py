...
class Catalog_Value_Capabilities:
    name: Any = None
    value: Any = None

@dataclasses.dataclass
class Catalog_Value_Msrp_P1Y:
    amount: Any = None
    currency_code: Any = None

@dataclasses.dataclass
class Catalog_Value_Msrp:
    p1_y: Any = None
    p3_y: Any = None
    p5_y: Any = None

@dataclasses.dataclass
class Catalog_Value_Restrictions:
...
Catalog = ubx.DataSourceBinding(
    wire_type="azure_reservations_catalog",
    fields={
