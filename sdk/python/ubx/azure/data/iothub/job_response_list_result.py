...
class JobResponseListResult_Value:
...
@dataclasses.dataclass
class JobResponseListResultConfig:
...
@dataclasses.dataclass
class JobResponseListResultAttrs:
    api_version: Any = None
    # The next link.
    next_link: Any = None
    resource_group_name: Any = None
...
JobResponseListResult = ubx.DataSourceBinding(
    wire_type="azure_iothub_job_response_list_result",
    fields={
