...
@dataclasses.dataclass
class Account_Value_Properties_AbusePenalty:
    action: Any = None
    expiration: Any = None
    rate_limit_percentage: Any = None

@dataclasses.dataclass
class Account_Value_Properties_AmlWorkspace:
    identity_client_id: Any = None
    resource_id: Any = None

@dataclasses.dataclass
class Account_Value_Properties_ApiProperties:
...
@dataclasses.dataclass
class Account_Value_Properties_CallRateLimit_Rules_MatchPatterns:
    method: Any = None
    path: Any = None

@dataclasses.dataclass
class Account_Value_Properties_CallRateLimit_Rules:
    count: Any = None
...
@dataclasses.dataclass
class Account_Value_Properties_CallRateLimit:
    count: Any = None
    renewal_period: Any = None
    rules: Any = None

@dataclasses.dataclass
class Account_Value_Properties_Capabilities:
    name: Any = None
    value: Any = None

@dataclasses.dataclass
class Account_Value_Properties_CommitmentPlanAssociations:
    commitment_plan_id: Any = None
    commitment_plan_location: Any = None

@dataclasses.dataclass
class Account_Value_Properties_Encryption_KeyVaultProperties:
    identity_client_id: Any = None
    key_name: Any = None
...
@dataclasses.dataclass
class Account_Value_Properties_Encryption:
    key_source: Any = None
    key_vault_properties: Any = None

@dataclasses.dataclass
class Account_Value_Properties_Locations_Regions:
    customsubdomain: Any = None
    name: Any = None
    value: Any = None

@dataclasses.dataclass
class Account_Value_Properties_Locations:
    regions: Any = None
    routing_method: Any = None

@dataclasses.dataclass
class Account_Value_Properties_NetworkAcls_IpRules:
    value: Any = None

@dataclasses.dataclass
class Account_Value_Properties_NetworkAcls_VirtualNetworkRules:
    id: Any = None
    ignore_missing_vnet_service_endpoint: Any = None
    state: Any = None

@dataclasses.dataclass
class Account_Value_Properties_NetworkAcls:
    bypass: Any = None
...
@dataclasses.dataclass
class Account_Value_Properties_NetworkInjections:
    scenario: Any = None
...
@dataclasses.dataclass
class Account_Value_Properties_RaiMonitorConfig:
    adx_storage_resource_id: Any = None
    identity_client_id: Any = None

@dataclasses.dataclass
class Account_Value_Properties_SkuChangeInfo:
