...
class AgentDeployment_Value_Properties_Agents:
    agent_version: Any = None

@dataclasses.dataclass
class AgentDeployment_Value_Properties_Protocols:
    protocol: Any = None
    version: Any = None

@dataclasses.dataclass
class AgentDeployment_Value_Properties:
    agents: Any = None
...
AgentDeployment = ubx.DataSourceBinding(
