...
class AgentDeploymentList_Value_Properties_Agents:
    agent_version: Any = None

@dataclasses.dataclass
class AgentDeploymentList_Value_Properties_Protocols:
    protocol: Any = None
    version: Any = None

@dataclasses.dataclass
class AgentDeploymentList_Value_Properties:
    agents: Any = None
...
@dataclasses.dataclass
class AgentDeploymentList_Value:
    properties: Any = None

@dataclasses.dataclass
class AgentDeploymentListConfig:
...
@dataclasses.dataclass
class AgentDeploymentListAttrs:
    account_name: Any = None
    app_name: Any = None
    count: Any = None
    names: Any = None
...
AgentDeploymentList = ubx.DataSourceBinding(
    wire_type="azure_cognitiveservices_agent_deployment_list",
    fields={
