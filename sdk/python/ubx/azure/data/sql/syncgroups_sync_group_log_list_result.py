...
class SyncgroupsSyncGroupLogListResult_Value:
    details: Any = None
...
@dataclasses.dataclass
class SyncgroupsSyncGroupLogListResultConfig:
...
@dataclasses.dataclass
class SyncgroupsSyncGroupLogListResultAttrs:
    continuation_token: Any = None
    database_name: Any = None
    end_time: Any = None
...
SyncgroupsSyncGroupLogListResult = ubx.DataSourceBinding(
    wire_type="azure_sql_syncgroups_sync_group_log_list_result",
    fields={
