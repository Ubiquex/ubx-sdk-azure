...
class JobstepsJobStepList_Value_Properties_Action:
    source: Any = None
    type: Any = None
    value: Any = None

@dataclasses.dataclass
class JobstepsJobStepList_Value_Properties_ExecutionOptions:
...
@dataclasses.dataclass
class JobstepsJobStepList_Value_Properties_Output:
    credential: Any = None
...
@dataclasses.dataclass
class JobstepsJobStepList_Value_Properties:
    action: Any = None
    credential: Any = None
...
@dataclasses.dataclass
class JobstepsJobStepList_Value:
    properties: Any = None

@dataclasses.dataclass
class JobstepsJobStepListConfig:
    job_agent_name: Any = None
    job_name: Any = None
    server_name: Any = None

@dataclasses.dataclass
class JobstepsJobStepListAttrs:
    job_agent_name: Any = None
    job_name: Any = None
...
JobstepsJobStepList = ubx.DataSourceBinding(
    wire_type="azure_sql_jobsteps_job_step_list",
    fields={
