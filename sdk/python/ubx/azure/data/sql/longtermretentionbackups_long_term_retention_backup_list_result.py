...
class LongtermretentionbackupsLongTermRetentionBackupListResult_Value_Properties:
...
@dataclasses.dataclass
class LongtermretentionbackupsLongTermRetentionBackupListResult_Value:
    properties: Any = None

@dataclasses.dataclass
class LongtermretentionbackupsLongTermRetentionBackupListResultConfig:
    database_state: Any = None
    location_name: Any = None
    only_latest_per_database: Any = None

@dataclasses.dataclass
class LongtermretentionbackupsLongTermRetentionBackupListResultAttrs:
    database_state: Any = None
    location_name: Any = None
...
LongtermretentionbackupsLongTermRetentionBackupListResult = ubx.DataSourceBinding(
    wire_type="azure_sql_longtermretentionbackups_long_term_retention_backup_list_result",
    fields={
