...
class SyncgroupsSyncGroupLogPropertiesList_Value:
    details: Any = None
...
@dataclasses.dataclass
class SyncgroupsSyncGroupLogPropertiesListConfig:
...
@dataclasses.dataclass
class SyncgroupsSyncGroupLogPropertiesListAttrs:
    continuation_token: Any = None
    database_name: Any = None
    end_time: Any = None
...
SyncgroupsSyncGroupLogPropertiesList = ubx.DataSourceBinding(
    wire_type="azure_sql_syncgroups_sync_group_log_properties_list",
    fields={
