...
class VolumeList_Value_Properties_DataProtection_Backup:
    backup_policy_id: Any = None
    backup_vault_id: Any = None
    policy_enforced: Any = None

@dataclasses.dataclass
class VolumeList_Value_Properties_DataProtection_RansomwareProtection:
    actual_ransomware_protection_state: Any = None
    desired_ransomware_protection_state: Any = None

@dataclasses.dataclass
class VolumeList_Value_Properties_DataProtection_Replication_DestinationReplications:
    region: Any = None
...
@dataclasses.dataclass
class VolumeList_Value_Properties_DataProtection_Replication_RemotePath:
    external_host_name: Any = None
    server_name: Any = None
    volume_name: Any = None

@dataclasses.dataclass
class VolumeList_Value_Properties_DataProtection_Replication:
...
@dataclasses.dataclass
class VolumeList_Value_Properties_DataProtection_Snapshot:
    snapshot_policy_id: Any = None

@dataclasses.dataclass
class VolumeList_Value_Properties_DataProtection_VolumeRelocation:
    ready_to_be_finalized: Any = None
    relocation_requested: Any = None

@dataclasses.dataclass
class VolumeList_Value_Properties_DataProtection:
    backup: Any = None
...
@dataclasses.dataclass
class VolumeList_Value_Properties_ExportPolicy_Rules:
...
@dataclasses.dataclass
class VolumeList_Value_Properties_ExportPolicy:
    rules: Any = None

@dataclasses.dataclass
class VolumeList_Value_Properties_MountTargets:
...
@dataclasses.dataclass
class VolumeList_Value_Properties_PlacementRules:
    key: Any = None
    value: Any = None

@dataclasses.dataclass
class VolumeList_Value_Properties:
...
@dataclasses.dataclass
class VolumeList_Value:
    etag: Any = None
    properties: Any = None
    zones: Any = None

@dataclasses.dataclass
class VolumeListConfig:
    account_name: Any = None
    pool_name: Any = None

@dataclasses.dataclass
class VolumeListAttrs:
    account_name: Any = None
...
VolumeList = ubx.DataSourceBinding(
    wire_type="azure_netapp_volume_list",
    fields={
