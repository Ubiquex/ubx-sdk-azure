...
class Cache_Value_Properties_ExportPolicy_Rules:
...
@dataclasses.dataclass
class Cache_Value_Properties_ExportPolicy:
    rules: Any = None

@dataclasses.dataclass
class Cache_Value_Properties_MountTargets:
    ip_address: Any = None
    mount_target_id: Any = None
    smb_server_fqdn: Any = None

@dataclasses.dataclass
class Cache_Value_Properties_OriginClusterInformation:
