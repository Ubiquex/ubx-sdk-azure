...
class ApimtenantTenantConfigurationSyncStateContract_Properties:
...
@dataclasses.dataclass
class ApimtenantTenantConfigurationSyncStateContractConfig:
    pass

@dataclasses.dataclass
class ApimtenantTenantConfigurationSyncStateContractAttrs:
    # Tenant Configuration Synchronization State.
    properties: Any = None

ApimtenantTenantConfigurationSyncStateContract = ubx.DataSourceBinding(
    wire_type="azure_apimanagement_apimtenant_tenant_configuration_sync_state_contract",
    fields={
    },
)
