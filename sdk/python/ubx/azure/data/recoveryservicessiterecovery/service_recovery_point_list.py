...
class ServiceRecoveryPointList_Value_Properties_ProviderSpecificDetails:
    instance_type: Any = None

@dataclasses.dataclass
class ServiceRecoveryPointList_Value_Properties:
    provider_specific_details: Any = None
    recovery_point_time: Any = None
    recovery_point_type: Any = None

@dataclasses.dataclass
class ServiceRecoveryPointList_Value:
    location: Any = None
    properties: Any = None

@dataclasses.dataclass
class ServiceRecoveryPointListConfig:
...
@dataclasses.dataclass
class ServiceRecoveryPointListAttrs:
    fabric_name: Any = None
...
ServiceRecoveryPointList = ubx.DataSourceBinding(
    wire_type="azure_recoveryservicessiterecovery_service_recovery_point_list",
    fields={
