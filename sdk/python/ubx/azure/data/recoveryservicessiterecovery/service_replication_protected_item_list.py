...
class ServiceReplicationProtectedItemList_Value_Properties_CurrentScenario:
    job_id: Any = None
    scenario_name: Any = None
    start_time: Any = None

@dataclasses.dataclass
class ServiceReplicationProtectedItemList_Value_Properties_HealthErrors_InnerHealthErrors:
...
@dataclasses.dataclass
class ServiceReplicationProtectedItemList_Value_Properties_HealthErrors:
    creation_time_utc: Any = None
    customer_resolvability: Any = None
    entity_id: Any = None
    error_category: Any = None
...
@dataclasses.dataclass
class ServiceReplicationProtectedItemList_Value_Properties_ProviderSpecificDetails:
    instance_type: Any = None

@dataclasses.dataclass
class ServiceReplicationProtectedItemList_Value_Properties:
...
@dataclasses.dataclass
class ServiceReplicationProtectedItemList_Value:
    location: Any = None
    properties: Any = None

@dataclasses.dataclass
class ServiceReplicationProtectedItemListConfig:
    fabric_name: Any = None
    protection_container_name: Any = None
    resource_name: Any = None

@dataclasses.dataclass
class ServiceReplicationProtectedItemListAttrs:
    fabric_name: Any = None
...
ServiceReplicationProtectedItemList = ubx.DataSourceBinding(
    wire_type="azure_recoveryservicessiterecovery_service_replication_protected_item_list",
    fields={
