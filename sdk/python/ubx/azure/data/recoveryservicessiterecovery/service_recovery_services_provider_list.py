...
class ServiceRecoveryServicesProviderList_Value_Properties_AuthenticationIdentityDetails:
...
@dataclasses.dataclass
class ServiceRecoveryServicesProviderList_Value_Properties_HealthErrorDetails_InnerHealthErrors:
...
@dataclasses.dataclass
class ServiceRecoveryServicesProviderList_Value_Properties_HealthErrorDetails:
    creation_time_utc: Any = None
    customer_resolvability: Any = None
    entity_id: Any = None
    error_category: Any = None
...
@dataclasses.dataclass
class ServiceRecoveryServicesProviderList_Value_Properties_ProviderVersionDetails:
    expiry_date: Any = None
    status: Any = None
    version: Any = None

@dataclasses.dataclass
class ServiceRecoveryServicesProviderList_Value_Properties:
...
@dataclasses.dataclass
class ServiceRecoveryServicesProviderList_Value:
    location: Any = None
    properties: Any = None

@dataclasses.dataclass
class ServiceRecoveryServicesProviderListConfig:
    fabric_name: Any = None
    resource_name: Any = None

@dataclasses.dataclass
class ServiceRecoveryServicesProviderListAttrs:
    fabric_name: Any = None
...
ServiceRecoveryServicesProviderList = ubx.DataSourceBinding(
    wire_type="azure_recoveryservicessiterecovery_service_recovery_services_provider_list",
    fields={
