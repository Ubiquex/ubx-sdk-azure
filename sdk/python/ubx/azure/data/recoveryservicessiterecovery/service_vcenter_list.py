...
class ServiceVcenterList_Value_Properties_HealthErrors_InnerHealthErrors:
...
@dataclasses.dataclass
class ServiceVcenterList_Value_Properties_HealthErrors:
    creation_time_utc: Any = None
    customer_resolvability: Any = None
    entity_id: Any = None
    error_category: Any = None
...
@dataclasses.dataclass
class ServiceVcenterList_Value_Properties:
...
@dataclasses.dataclass
class ServiceVcenterList_Value:
    location: Any = None
    properties: Any = None

@dataclasses.dataclass
class ServiceVcenterListConfig:
    fabric_name: Any = None
    resource_name: Any = None

@dataclasses.dataclass
class ServiceVcenterListAttrs:
    fabric_name: Any = None
...
ServiceVcenterList = ubx.DataSourceBinding(
    wire_type="azure_recoveryservicessiterecovery_service_vcenter_list",
    fields={
