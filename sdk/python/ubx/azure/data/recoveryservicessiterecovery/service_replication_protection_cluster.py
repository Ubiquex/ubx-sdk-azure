...
class ServiceReplicationProtectionCluster_Value_Properties_ClusterRegisteredNodes:
    bios_id: Any = None
...
@dataclasses.dataclass
class ServiceReplicationProtectionCluster_Value_Properties_CurrentScenario:
    job_id: Any = None
    scenario_name: Any = None
    start_time: Any = None

@dataclasses.dataclass
class ServiceReplicationProtectionCluster_Value_Properties_HealthErrors_InnerHealthErrors:
...
@dataclasses.dataclass
class ServiceReplicationProtectionCluster_Value_Properties_HealthErrors:
    creation_time_utc: Any = None
    customer_resolvability: Any = None
    entity_id: Any = None
    error_category: Any = None
...
@dataclasses.dataclass
class ServiceReplicationProtectionCluster_Value_Properties_ProviderSpecificDetails:
    instance_type: Any = None

@dataclasses.dataclass
class ServiceReplicationProtectionCluster_Value_Properties_SharedDiskProperties:
...
@dataclasses.dataclass
class ServiceReplicationProtectionCluster_Value_Properties:
    active_location: Any = None
...
@dataclasses.dataclass
class ServiceReplicationProtectionCluster_Value:
    properties: Any = None
