...
class ServiceProtectionContainerMappingCollection_Value_Properties_HealthErrorDetails_InnerHealthErrors:
...
@dataclasses.dataclass
class ServiceProtectionContainerMappingCollection_Value_Properties_HealthErrorDetails:
    creation_time_utc: Any = None
    customer_resolvability: Any = None
    entity_id: Any = None
    error_category: Any = None
...
@dataclasses.dataclass
class ServiceProtectionContainerMappingCollection_Value_Properties_ProviderSpecificDetails:
    instance_type: Any = None

@dataclasses.dataclass
class ServiceProtectionContainerMappingCollection_Value_Properties:
    health: Any = None
...
@dataclasses.dataclass
class ServiceProtectionContainerMappingCollection_Value:
    location: Any = None
    properties: Any = None

@dataclasses.dataclass
class ServiceProtectionContainerMappingCollectionConfig:
    fabric_name: Any = None
    protection_container_name: Any = None
    resource_name: Any = None

@dataclasses.dataclass
class ServiceProtectionContainerMappingCollectionAttrs:
    fabric_name: Any = None
...
ServiceProtectionContainerMappingCollection = ubx.DataSourceBinding(
    wire_type="azure_recoveryservicessiterecovery_service_protection_container_mapping_collection",
    fields={
