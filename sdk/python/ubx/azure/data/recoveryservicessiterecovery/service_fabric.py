...
class ServiceFabric_Value_Properties_CustomDetails:
    instance_type: Any = None

@dataclasses.dataclass
class ServiceFabric_Value_Properties_EncryptionDetails:
    kek_cert_expiry_date: Any = None
    kek_cert_thumbprint: Any = None
    kek_state: Any = None

@dataclasses.dataclass
class ServiceFabric_Value_Properties_HealthErrorDetails_InnerHealthErrors:
...
@dataclasses.dataclass
class ServiceFabric_Value_Properties_HealthErrorDetails:
    creation_time_utc: Any = None
    customer_resolvability: Any = None
    entity_id: Any = None
    error_category: Any = None
...
@dataclasses.dataclass
class ServiceFabric_Value_Properties:
    bcdr_state: Any = None
...
ServiceFabric = ubx.DataSourceBinding(
