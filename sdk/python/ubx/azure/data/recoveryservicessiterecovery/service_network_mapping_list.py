...
class ServiceNetworkMappingList_Value_Properties_FabricSpecificSettings:
    instance_type: Any = None

@dataclasses.dataclass
class ServiceNetworkMappingList_Value_Properties:
...
@dataclasses.dataclass
class ServiceNetworkMappingList_Value:
    location: Any = None
    properties: Any = None

@dataclasses.dataclass
class ServiceNetworkMappingListConfig:
    fabric_name: Any = None
    network_name: Any = None
    resource_name: Any = None

@dataclasses.dataclass
class ServiceNetworkMappingListAttrs:
    fabric_name: Any = None
    network_name: Any = None
...
ServiceNetworkMappingList = ubx.DataSourceBinding(
    wire_type="azure_recoveryservicessiterecovery_service_network_mapping_list",
    fields={
