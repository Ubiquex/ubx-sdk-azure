...
class ServiceMigrationItemList_Value_Properties_CriticalJobHistory:
    job_id: Any = None
    job_name: Any = None
    job_status: Any = None
    start_time: Any = None
...
@dataclasses.dataclass
class ServiceMigrationItemList_Value_Properties_CurrentJob:
    job_id: Any = None
    job_name: Any = None
    start_time: Any = None

@dataclasses.dataclass
class ServiceMigrationItemList_Value_Properties_HealthErrors_InnerHealthErrors:
...
@dataclasses.dataclass
class ServiceMigrationItemList_Value_Properties_HealthErrors:
    creation_time_utc: Any = None
    customer_resolvability: Any = None
    entity_id: Any = None
    error_category: Any = None
...
@dataclasses.dataclass
class ServiceMigrationItemList_Value_Properties_ProviderSpecificDetails:
    instance_type: Any = None

@dataclasses.dataclass
class ServiceMigrationItemList_Value_Properties:
...
@dataclasses.dataclass
class ServiceMigrationItemList_Value:
    location: Any = None
    properties: Any = None

@dataclasses.dataclass
class ServiceMigrationItemListConfig:
...
@dataclasses.dataclass
class ServiceMigrationItemListAttrs:
    fabric_name: Any = None
...
ServiceMigrationItemList = ubx.DataSourceBinding(
    wire_type="azure_recoveryservicessiterecovery_service_migration_item_list",
    fields={
