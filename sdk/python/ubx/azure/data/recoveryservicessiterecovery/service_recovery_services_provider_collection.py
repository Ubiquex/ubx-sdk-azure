...
class ServiceRecoveryServicesProviderCollection_Value_Properties_AuthenticationIdentityDetails:
...
@dataclasses.dataclass
class ServiceRecoveryServicesProviderCollection_Value_Properties_HealthErrorDetails_InnerHealthErrors:
...
@dataclasses.dataclass
class ServiceRecoveryServicesProviderCollection_Value_Properties_HealthErrorDetails:
    creation_time_utc: Any = None
    customer_resolvability: Any = None
    entity_id: Any = None
    error_category: Any = None
...
@dataclasses.dataclass
class ServiceRecoveryServicesProviderCollection_Value_Properties_ProviderVersionDetails:
    expiry_date: Any = None
    status: Any = None
    version: Any = None

@dataclasses.dataclass
class ServiceRecoveryServicesProviderCollection_Value_Properties:
...
@dataclasses.dataclass
class ServiceRecoveryServicesProviderCollection_Value:
    location: Any = None
    properties: Any = None

@dataclasses.dataclass
class ServiceRecoveryServicesProviderCollectionConfig:
    fabric_name: Any = None
    resource_name: Any = None

@dataclasses.dataclass
class ServiceRecoveryServicesProviderCollectionAttrs:
    fabric_name: Any = None
...
ServiceRecoveryServicesProviderCollection = ubx.DataSourceBinding(
    wire_type="azure_recoveryservicessiterecovery_service_recovery_services_provider_collection",
    fields={
