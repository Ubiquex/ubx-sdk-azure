...
class ServiceVcenter_Value_Properties_HealthErrors_InnerHealthErrors:
...
@dataclasses.dataclass
class ServiceVcenter_Value_Properties_HealthErrors:
    creation_time_utc: Any = None
    customer_resolvability: Any = None
    entity_id: Any = None
    error_category: Any = None
...
@dataclasses.dataclass
class ServiceVcenter_Value_Properties:
...
ServiceVcenter = ubx.DataSourceBinding(
