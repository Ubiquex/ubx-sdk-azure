...
class OpenapiDbVersionList_Value_Properties:
...
@dataclasses.dataclass
class OpenapiDbVersionList_Value:
    properties: Any = None

@dataclasses.dataclass
class OpenapiDbVersionListConfig:
...
@dataclasses.dataclass
class OpenapiDbVersionListAttrs:
    db_system_id: Any = None
    db_system_shape: Any = None
    is_database_software_image_supported: Any = None
    is_upgrade_supported: Any = None
...
OpenapiDbVersionList = ubx.DataSourceBinding(
    wire_type="azure_oracle_openapi_db_version_list",
    fields={
