...
class OpenapiFlexComponentList_Value_Properties:
...
@dataclasses.dataclass
class OpenapiFlexComponentList_Value:
    properties: Any = None

@dataclasses.dataclass
class OpenapiFlexComponentListConfig:
    shape: Any = None

@dataclasses.dataclass
class OpenapiFlexComponentListAttrs:
...
OpenapiFlexComponentList = ubx.DataSourceBinding(
    wire_type="azure_oracle_openapi_flex_component_list",
    fields={
