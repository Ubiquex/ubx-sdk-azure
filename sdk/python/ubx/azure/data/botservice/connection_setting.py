...
class ConnectionSetting_Value_Properties_Parameters:
    key: Any = None
    value: Any = None

@dataclasses.dataclass
class ConnectionSetting_Value_Properties:
    client_id: Any = None
...
ConnectionSetting = ubx.DataSourceBinding(
