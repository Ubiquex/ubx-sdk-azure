...
class ChannelResponseList_Value_Properties:
...
@dataclasses.dataclass
class ChannelResponseList_Value:
    properties: Any = None

@dataclasses.dataclass
class ChannelResponseListConfig:
...
@dataclasses.dataclass
class ChannelResponseListAttrs:
    api_version: Any = None
...
ChannelResponseList = ubx.DataSourceBinding(
    wire_type="azure_botservice_channel_response_list",
    fields={
