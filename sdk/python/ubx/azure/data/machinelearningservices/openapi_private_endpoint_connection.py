...
class OpenapiPrivateEndpointConnection_Value_Identity_UserAssignedIdentities:
    client_id: Any = None
    principal_id: Any = None

@dataclasses.dataclass
class OpenapiPrivateEndpointConnection_Value_Identity:
    principal_id: Any = None
    tenant_id: Any = None
    type: Any = None
...
@dataclasses.dataclass
class OpenapiPrivateEndpointConnection_Value_Sku:
    capacity: Any = None
    family: Any = None
    name: Any = None
    size: Any = None
