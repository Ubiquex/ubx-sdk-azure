...
class VirtualwanVpnConnectionList_Value_Properties_IpsecPolicies:
    dh_group: Any = None
...
@dataclasses.dataclass
class VirtualwanVpnConnectionList_Value_Properties_RemoteVpnSite:
    id: Any = None

@dataclasses.dataclass
class VirtualwanVpnConnectionList_Value_Properties_RoutingConfiguration_PropagatedRouteTables:
    ids: Any = None
    labels: Any = None

@dataclasses.dataclass
class VirtualwanVpnConnectionList_Value_Properties_RoutingConfiguration_VnetRoutes_StaticRoutes:
    address_prefixes: Any = None
    name: Any = None
    next_hop_ip_address: Any = None

@dataclasses.dataclass
class VirtualwanVpnConnectionList_Value_Properties_RoutingConfiguration_VnetRoutes_StaticRoutesConfig:
    propagate_static_routes: Any = None
    vnet_local_route_override_criteria: Any = None

@dataclasses.dataclass
class VirtualwanVpnConnectionList_Value_Properties_RoutingConfiguration_VnetRoutes:
    bgp_connections: Any = None
    static_routes: Any = None
    static_routes_config: Any = None

@dataclasses.dataclass
class VirtualwanVpnConnectionList_Value_Properties_RoutingConfiguration:
...
@dataclasses.dataclass
class VirtualwanVpnConnectionList_Value_Properties_TrafficSelectorPolicies:
    local_address_ranges: Any = None
    remote_address_ranges: Any = None

@dataclasses.dataclass
class VirtualwanVpnConnectionList_Value_Properties_VpnLinkConnections_Properties_VpnGatewayCustomBgpAddresses:
    custom_bgp_ip_address: Any = None
    ip_configuration_id: Any = None

@dataclasses.dataclass
class VirtualwanVpnConnectionList_Value_Properties_VpnLinkConnections_Properties:
...
@dataclasses.dataclass
class VirtualwanVpnConnectionList_Value_Properties_VpnLinkConnections:
    etag: Any = None
    properties: Any = None

@dataclasses.dataclass
class VirtualwanVpnConnectionList_Value_Properties:
    connection_bandwidth: Any = None
    connection_status: Any = None
    dpd_timeout_seconds: Any = None
    egress_bytes_transferred: Any = None
...
@dataclasses.dataclass
class VirtualwanVpnConnectionList_Value:
    etag: Any = None
    name: Any = None
    properties: Any = None

@dataclasses.dataclass
class VirtualwanVpnConnectionListConfig:
    gateway_name: Any = None

@dataclasses.dataclass
class VirtualwanVpnConnectionListAttrs:
    gateway_name: Any = None
...
VirtualwanVpnConnectionList = ubx.DataSourceBinding(
    wire_type="azure_network_virtualwan_vpn_connection_list",
    fields={
