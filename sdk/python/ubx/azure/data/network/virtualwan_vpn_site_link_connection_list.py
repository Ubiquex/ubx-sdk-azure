...
class VirtualwanVpnSiteLinkConnectionList_Value_Properties_EgressNatRules:
    id: Any = None

@dataclasses.dataclass
class VirtualwanVpnSiteLinkConnectionList_Value_Properties_IpsecPolicies:
    dh_group: Any = None
...
@dataclasses.dataclass
class VirtualwanVpnSiteLinkConnectionList_Value_Properties_VpnGatewayCustomBgpAddresses:
    custom_bgp_ip_address: Any = None
    ip_configuration_id: Any = None

@dataclasses.dataclass
class VirtualwanVpnSiteLinkConnectionList_Value_Properties:
...
@dataclasses.dataclass
class VirtualwanVpnSiteLinkConnectionList_Value:
    etag: Any = None
    properties: Any = None

@dataclasses.dataclass
class VirtualwanVpnSiteLinkConnectionListConfig:
    connection_name: Any = None
    gateway_name: Any = None

@dataclasses.dataclass
class VirtualwanVpnSiteLinkConnectionListAttrs:
    connection_name: Any = None
    gateway_name: Any = None
...
VirtualwanVpnSiteLinkConnectionList = ubx.DataSourceBinding(
    wire_type="azure_network_virtualwan_vpn_site_link_connection_list",
    fields={
