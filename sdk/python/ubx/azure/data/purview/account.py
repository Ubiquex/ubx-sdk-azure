...
class Account_Value_Properties_AccountStatus_ErrorDetails_Details_Details:
    pass

@dataclasses.dataclass
class Account_Value_Properties_AccountStatus_ErrorDetails_Details:
    code: Any = None
    details: Any = None
    message: Any = None
    target: Any = None
...
@dataclasses.dataclass
class Account_Value_Properties_AccountStatus_ErrorDetails:
    code: Any = None
    details: Any = None
    message: Any = None
    target: Any = None
...
@dataclasses.dataclass
class Account_Value_Properties_AccountStatus:
    account_provisioning_state: Any = None
    error_details: Any = None

@dataclasses.dataclass
class Account_Value_Properties_CloudConnectors:
    aws_external_id: Any = None

@dataclasses.dataclass
class Account_Value_Properties_Endpoints:
    catalog: Any = None
    guardian: Any = None
    scan: Any = None

@dataclasses.dataclass
class Account_Value_Properties_ManagedResources:
