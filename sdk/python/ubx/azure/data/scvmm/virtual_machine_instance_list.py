...
class VirtualMachineInstanceList_Value_ExtendedLocation:
    name: Any = None
    type: Any = None

@dataclasses.dataclass
class VirtualMachineInstanceList_Value_Properties_AvailabilitySets:
    id: Any = None
    name: Any = None

@dataclasses.dataclass
class VirtualMachineInstanceList_Value_Properties_HardwareProfile:
    cpu_count: Any = None
...
@dataclasses.dataclass
class VirtualMachineInstanceList_Value_Properties_InfrastructureProfile_Checkpoints:
...
@dataclasses.dataclass
class VirtualMachineInstanceList_Value_Properties_InfrastructureProfile:
    bios_guid: Any = None
...
@dataclasses.dataclass
class VirtualMachineInstanceList_Value_Properties_NetworkProfile_NetworkInterfaces:
...
@dataclasses.dataclass
class VirtualMachineInstanceList_Value_Properties_NetworkProfile:
    network_interfaces: Any = None

@dataclasses.dataclass
class VirtualMachineInstanceList_Value_Properties_OsProfile:
...
@dataclasses.dataclass
class VirtualMachineInstanceList_Value_Properties_StorageProfile_Disks:
    bus: Any = None
    bus_type: Any = None
...
@dataclasses.dataclass
class VirtualMachineInstanceList_Value_Properties_StorageProfile:
    disks: Any = None

@dataclasses.dataclass
class VirtualMachineInstanceList_Value_Properties:
...
@dataclasses.dataclass
class VirtualMachineInstanceList_Value:
    extended_location: Any = None
    properties: Any = None

@dataclasses.dataclass
class VirtualMachineInstanceListConfig:
    resource_uri: Any = None

@dataclasses.dataclass
class VirtualMachineInstanceListAttrs:
...
VirtualMachineInstanceList = ubx.DataSourceBinding(
    wire_type="azure_scvmm_virtual_machine_instance_list",
    fields={
