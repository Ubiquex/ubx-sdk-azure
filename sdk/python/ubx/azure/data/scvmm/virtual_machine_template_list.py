...
class VirtualMachineTemplateList_Value_ExtendedLocation:
    name: Any = None
    type: Any = None

@dataclasses.dataclass
class VirtualMachineTemplateList_Value_Properties_Disks_StorageQoSpolicy:
    id: Any = None
    name: Any = None

@dataclasses.dataclass
class VirtualMachineTemplateList_Value_Properties_Disks:
    bus: Any = None
    bus_type: Any = None
...
@dataclasses.dataclass
class VirtualMachineTemplateList_Value_Properties_NetworkInterfaces:
    display_name: Any = None
...
@dataclasses.dataclass
class VirtualMachineTemplateList_Value_Properties:
...
@dataclasses.dataclass
class VirtualMachineTemplateList_Value:
    extended_location: Any = None
    properties: Any = None

@dataclasses.dataclass
class VirtualMachineTemplateListConfig:
    pass

@dataclasses.dataclass
class VirtualMachineTemplateListAttrs:
    # The link to the next page of items
    next_link: Any = None
    # The VirtualMachineTemplate items on this page
    value: Any = None

VirtualMachineTemplateList = ubx.DataSourceBinding(
    wire_type="azure_scvmm_virtual_machine_template_list",
    fields={
    },
)
