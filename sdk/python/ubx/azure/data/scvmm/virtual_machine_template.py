...
class VirtualMachineTemplate_Value_ExtendedLocation:
    name: Any = None
    type: Any = None

@dataclasses.dataclass
class VirtualMachineTemplate_Value_Properties_Disks_StorageQoSpolicy:
    id: Any = None
    name: Any = None

@dataclasses.dataclass
class VirtualMachineTemplate_Value_Properties_Disks:
    bus: Any = None
    bus_type: Any = None
...
@dataclasses.dataclass
class VirtualMachineTemplate_Value_Properties_NetworkInterfaces:
    display_name: Any = None
...
@dataclasses.dataclass
class VirtualMachineTemplate_Value_Properties:
...
@dataclasses.dataclass
class VirtualMachineTemplate_Value:
...
VirtualMachineTemplate = ubx.DataSourceBinding(
