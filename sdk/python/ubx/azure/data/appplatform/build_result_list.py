...
class BuildResultList_Value_Properties_BuildStages:
    exit_code: Any = None
    name: Any = None
    reason: Any = None
    status: Any = None
...
@dataclasses.dataclass
class BuildResultList_Value_Properties_Error:
    code: Any = None
    message: Any = None

@dataclasses.dataclass
class BuildResultList_Value_Properties:
...
@dataclasses.dataclass
class BuildResultList_Value:
    properties: Any = None

@dataclasses.dataclass
class BuildResultListConfig:
...
BuildResultList = ubx.DataSourceBinding(
    wire_type="azure_appplatform_build_result_list",
    fields={
