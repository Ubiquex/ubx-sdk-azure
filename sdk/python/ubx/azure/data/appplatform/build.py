...
class Build_Value_Properties_Apms:
    resource_id: Any = None

@dataclasses.dataclass
class Build_Value_Properties_ResourceRequests:
    cpu: Any = None
    memory: Any = None

@dataclasses.dataclass
class Build_Value_Properties_TriggeredBuildResult:
    id: Any = None
    image: Any = None
