...
class OpenapiBatchEndpoint_Identity_UserAssignedIdentities:
    client_id: Any = None
    principal_id: Any = None

@dataclasses.dataclass
class OpenapiBatchEndpoint_Identity:
...
@dataclasses.dataclass
class OpenapiBatchEndpoint_Properties_Defaults:
...
@dataclasses.dataclass
class OpenapiBatchEndpoint_Properties:
...
@dataclasses.dataclass
class OpenapiBatchEndpoint_Sku:
...
_OpenapiBatchEndpoint_Identity_UserAssignedIdentitiesFields = {
    "client_id": ubx.FieldSpec(wire_name="client_id"),
    "principal_id": ubx.FieldSpec(wire_name="principal_id"),
}

_OpenapiBatchEndpoint_IdentityFields = {
    "principal_id": ubx.FieldSpec(wire_name="principal_id"),
    ...
    "user_assigned_identities": ubx.FieldSpec(
        ...
        kind="map",
        fields=_OpenapiBatchEndpoint_Identity_UserAssignedIdentitiesFields,
    ),
}

_OpenapiBatchEndpoint_Properties_DefaultsFields = {
    "deployment_name": ubx.FieldSpec(wire_name="deployment_name"),
}

_OpenapiBatchEndpoint_PropertiesFields = {
    "defaults": ubx.FieldSpec(
        wire_name="defaults",
        kind="object",
        fields=_OpenapiBatchEndpoint_Properties_DefaultsFields,
    ),
    "provisioning_state": ubx.FieldSpec(wire_name="provisioning_state"),
}

_OpenapiBatchEndpoint_SkuFields = {
...
OpenapiBatchEndpoint = ubx.ResourceBinding(
    ...
    fields={
        ...
        "properties": ubx.FieldSpec(
            ...
            kind="object",
            fields=_OpenapiBatchEndpoint_PropertiesFields,
        ),
        "sku": ubx.FieldSpec(
            wire_name="sku",
            kind="object",
