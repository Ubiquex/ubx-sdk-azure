...
class CognitiveservicesAgentDeployment_Properties_Agents:
    agent_version: Any = None

@dataclasses.dataclass
class CognitiveservicesAgentDeployment_Properties_Protocols:
    protocol: Any = None
    version: Any = None

@dataclasses.dataclass
class CognitiveservicesAgentDeployment_Properties:
...
_CognitiveservicesAgentDeployment_Properties_AgentsFields = {
    "agent_version": ubx.FieldSpec(wire_name="agent_version"),
}

_CognitiveservicesAgentDeployment_Properties_ProtocolsFields = {
    "protocol": ubx.FieldSpec(wire_name="protocol"),
    "version": ubx.FieldSpec(wire_name="version"),
}

_CognitiveservicesAgentDeployment_PropertiesFields = {
    "agents": ubx.FieldSpec(
        wire_name="agents",
        kind="list",
        fields=_CognitiveservicesAgentDeployment_Properties_AgentsFields,
    ),
    ...
    "protocols": ubx.FieldSpec(
        wire_name="protocols",
        kind="list",
        fields=_CognitiveservicesAgentDeployment_Properties_ProtocolsFields,
    ),
...
@dataclasses.dataclass
class CognitiveservicesAgentDeploymentConfig:
    # Type representing an agent deployment as a management construct.
    properties: Any = None

@dataclasses.dataclass
class CognitiveservicesAgentDeploymentAttrs:
    # Type representing an agent deployment as a management construct.
    properties: Any = None

CognitiveservicesAgentDeployment = ubx.ResourceBinding(
    wire_type="azure_cognitiveservices_cognitiveservices_agent_deployment",
    fields={
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_CognitiveservicesAgentDeployment_PropertiesFields,
        ),
    },
)
