...
@dataclasses.dataclass
class Deployment_Properties_CallRateLimit:
...
@dataclasses.dataclass
class Deployment_Properties_CapacitySettings:
...
@dataclasses.dataclass
class Deployment_Properties_Model:
...
@dataclasses.dataclass
class Deployment_Properties_Routing:
...
@dataclasses.dataclass
class Deployment_Properties_ScaleSettings:
...
_Deployment_Properties_CallRateLimit_Rules_MatchPatternsFields = {
    "method": ubx.FieldSpec(wire_name="method"),
    "path": ubx.FieldSpec(wire_name="path"),
}

_Deployment_Properties_CallRateLimit_RulesFields = {
    ...
    "match_patterns": ubx.FieldSpec(
        ...
        kind="list",
        fields=_Deployment_Properties_CallRateLimit_Rules_MatchPatternsFields,
    ),
    "min_count": ubx.FieldSpec(wire_name="min_count"),
    "renewal_period": ubx.FieldSpec(wire_name="renewal_period"),
}

_Deployment_Properties_CallRateLimitFields = {
    "count": ubx.FieldSpec(wire_name="count"),
    "renewal_period": ubx.FieldSpec(wire_name="renewal_period"),
    "rules": ubx.FieldSpec(
        wire_name="rules",
        kind="list",
        fields=_Deployment_Properties_CallRateLimit_RulesFields,
    ),
}

_Deployment_Properties_CapacitySettingsFields = {
    "designated_capacity": ubx.FieldSpec(wire_name="designated_capacity"),
    "priority": ubx.FieldSpec(wire_name="priority"),
}

_Deployment_Properties_ModelFields = {
    "call_rate_limit": ubx.FieldSpec(
        wire_name="call_rate_limit",
        kind="object",
        fields=_Deployment_Properties_CallRateLimitFields,
    ),
...
_Deployment_Properties_RoutingFields = {
    "mode": ubx.FieldSpec(wire_name="mode"),
    "models": ubx.FieldSpec(
        wire_name="models",
        kind="list",
        fields=_Deployment_Properties_ModelFields,
    ),
}

_Deployment_Properties_ScaleSettingsFields = {
...
_Deployment_PropertiesFields = {
    ...
    "capacity_settings": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Deployment_Properties_CapacitySettingsFields,
    ),
    ...
    "routing": ubx.FieldSpec(
        wire_name="routing",
        kind="object",
        fields=_Deployment_Properties_RoutingFields,
    ),
    "scale_settings": ubx.FieldSpec(
        wire_name="scale_settings",
        kind="object",
        fields=_Deployment_Properties_ScaleSettingsFields,
    ),
...
Deployment = ubx.ResourceBinding(
    wire_type="azure_cognitiveservices_deployment",
    fields={
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_Deployment_PropertiesFields,
        ),
        "sku": ubx.FieldSpec(
            wire_name="sku",
            kind="object",
