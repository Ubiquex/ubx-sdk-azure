...
class EventgridPermissionBinding_Properties:
...
@dataclasses.dataclass
class EventgridPermissionBinding_SystemData:
...
_EventgridPermissionBinding_PropertiesFields = {
...
_EventgridPermissionBinding_SystemDataFields = {
...
@dataclasses.dataclass
class EventgridPermissionBindingConfig:
...
@dataclasses.dataclass
class EventgridPermissionBindingAttrs:
    # The properties of permission binding.
    properties: Any = None
    # Metadata pertaining to creation and last modification of the resource.
    system_data: Any = None

EventgridPermissionBinding = ubx.ResourceBinding(
    wire_type="azure_eventgrid_eventgrid_permission_binding",
    fields={
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_EventgridPermissionBinding_PropertiesFields,
        ),
        "system_data": ubx.FieldSpec(
            wire_name="system_data",
            kind="object",
            fields=_EventgridPermissionBinding_SystemDataFields,
        ),
    },
)
