...
class EventgridPartnerNamespace_Properties_InboundIpRules:
    action: Any = None
    ip_mask: Any = None

@dataclasses.dataclass
class EventgridPartnerNamespace_Properties_PrivateEndpointConnections_Properties_PrivateEndpoint:
    id: Any = None

@dataclasses.dataclass
class EventgridPartnerNamespace_Properties_PrivateEndpointConnections_Properties_PrivateLinkServiceConnectionState:
    actions_required: Any = None
    description: Any = None
    status: Any = None

@dataclasses.dataclass
class EventgridPartnerNamespace_Properties_PrivateEndpointConnections_Properties:
    group_ids: Any = None
...
@dataclasses.dataclass
class EventgridPartnerNamespace_Properties_PrivateEndpointConnections:
    properties: Any = None

@dataclasses.dataclass
class EventgridPartnerNamespace_Properties:
...
@dataclasses.dataclass
class EventgridPartnerNamespace_SystemData:
...
_EventgridPartnerNamespace_Properties_InboundIpRulesFields = {
    "action": ubx.FieldSpec(wire_name="action"),
    "ip_mask": ubx.FieldSpec(wire_name="ip_mask"),
}

_EventgridPartnerNamespace_Properties_PrivateEndpointConnections_Properties_PrivateEndpointFields = {
    "id": ubx.FieldSpec(wire_name="id"),
}

_EventgridPartnerNamespace_Properties_PrivateEndpointConnections_Properties_PrivateLinkServiceConnectionStateFields = {
    "actions_required": ubx.FieldSpec(wire_name="actions_required"),
    "description": ubx.FieldSpec(wire_name="description"),
    "status": ubx.FieldSpec(wire_name="status"),
}

_EventgridPartnerNamespace_Properties_PrivateEndpointConnections_PropertiesFields = {
    "group_ids": ubx.FieldSpec(wire_name="group_ids"),
    "private_endpoint": ubx.FieldSpec(
        wire_name="private_endpoint",
        kind="object",
        fields=_EventgridPartnerNamespace_Properties_PrivateEndpointConnections_Properties_PrivateEndpointFields,
    ),
    "private_link_service_connection_state": ubx.FieldSpec(
        wire_name="private_link_service_connection_state",
        kind="object",
        fields=_EventgridPartnerNamespace_Properties_PrivateEndpointConnections_Properties_PrivateLinkServiceConnectionStateFields,
    ),
    "provisioning_state": ubx.FieldSpec(wire_name="provisioning_state"),
}

_EventgridPartnerNamespace_Properties_PrivateEndpointConnectionsFields = {
    "properties": ubx.FieldSpec(
        wire_name="properties",
        kind="object",
        fields=_EventgridPartnerNamespace_Properties_PrivateEndpointConnections_PropertiesFields,
    ),
}

_EventgridPartnerNamespace_PropertiesFields = {
    ...
    "inbound_ip_rules": ubx.FieldSpec(
        ...
        kind="list",
        fields=_EventgridPartnerNamespace_Properties_InboundIpRulesFields,
    ),
    ...
    "private_endpoint_connections": ubx.FieldSpec(
        ...
        kind="list",
        fields=_EventgridPartnerNamespace_Properties_PrivateEndpointConnectionsFields,
    ),
    "provisioning_state": ubx.FieldSpec(wire_name="provisioning_state"),
    "public_network_access": ubx.FieldSpec(wire_name="public_network_access"),
}

_EventgridPartnerNamespace_SystemDataFields = {
...
@dataclasses.dataclass
class EventgridPartnerNamespaceConfig:
...
@dataclasses.dataclass
class EventgridPartnerNamespaceAttrs:
    # Properties of the partner namespace.
    properties: Any = None
    # Metadata pertaining to creation and last modification of the resource.
    system_data: Any = None

EventgridPartnerNamespace = ubx.ResourceBinding(
    wire_type="azure_eventgrid_eventgrid_partner_namespace",
    fields={
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_EventgridPartnerNamespace_PropertiesFields,
        ),
        "system_data": ubx.FieldSpec(
            wire_name="system_data",
            kind="object",
            fields=_EventgridPartnerNamespace_SystemDataFields,
        ),
    },
)
