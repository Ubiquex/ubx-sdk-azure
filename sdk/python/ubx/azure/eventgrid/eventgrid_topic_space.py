...
class EventgridTopicSpace_Properties:
...
@dataclasses.dataclass
class EventgridTopicSpace_SystemData:
...
_EventgridTopicSpace_PropertiesFields = {
...
_EventgridTopicSpace_SystemDataFields = {
...
@dataclasses.dataclass
class EventgridTopicSpaceConfig:
...
@dataclasses.dataclass
class EventgridTopicSpaceAttrs:
    # The properties of topic space.
    properties: Any = None
    # Metadata pertaining to creation and last modification of the resource.
    system_data: Any = None

EventgridTopicSpace = ubx.ResourceBinding(
    wire_type="azure_eventgrid_eventgrid_topic_space",
    fields={
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_EventgridTopicSpace_PropertiesFields,
        ),
        "system_data": ubx.FieldSpec(
            wire_name="system_data",
            kind="object",
            fields=_EventgridTopicSpace_SystemDataFields,
        ),
    },
)
