...
class VmmServer_ExtendedLocation:
...
@dataclasses.dataclass
class VmmServer_Properties_Credentials:
...
VmmServer = ubx.ResourceBinding(
    wire_type="azure_scvmm_vmm_server",
    fields={
        "extended_location": ubx.FieldSpec(
            wire_name="extended_location",
            kind="object",
            fields=_VmmServer_ExtendedLocationFields,
        ),
        "location": ubx.FieldSpec(wire_name="location"),
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_VmmServer_PropertiesFields,
        ),
