...
class ScvmmVirtualMachineTemplate_ExtendedLocation:
...
@dataclasses.dataclass
class ScvmmVirtualMachineTemplate_Properties_Disks_StorageQoSpolicy:
    id: Any = None
    name: Any = None

@dataclasses.dataclass
class ScvmmVirtualMachineTemplate_Properties_Disks:
    bus: Any = None
    bus_type: Any = None
...
@dataclasses.dataclass
class ScvmmVirtualMachineTemplate_Properties_NetworkInterfaces:
    display_name: Any = None
...
@dataclasses.dataclass
class ScvmmVirtualMachineTemplate_Properties:
    # Gets computer name.
...
_ScvmmVirtualMachineTemplate_ExtendedLocationFields = {
    "name": ubx.FieldSpec(wire_name="name"),
    "type": ubx.FieldSpec(wire_name="type"),
}

_ScvmmVirtualMachineTemplate_Properties_Disks_StorageQoSpolicyFields = {
    "id": ubx.FieldSpec(wire_name="id"),
    "name": ubx.FieldSpec(wire_name="name"),
}

_ScvmmVirtualMachineTemplate_Properties_DisksFields = {
    ...
    "storage_qo_spolicy": ubx.FieldSpec(
        ...
        kind="object",
        fields=_ScvmmVirtualMachineTemplate_Properties_Disks_StorageQoSpolicyFields,
    ),
...
_ScvmmVirtualMachineTemplate_Properties_NetworkInterfacesFields = {
    "display_name": ubx.FieldSpec(wire_name="display_name"),
...
_ScvmmVirtualMachineTemplate_PropertiesFields = {
    "computer_name": ubx.FieldSpec(wire_name="computer_name"),
    "cpu_count": ubx.FieldSpec(wire_name="cpu_count"),
    "disks": ubx.FieldSpec(
        wire_name="disks",
        kind="list",
        fields=_ScvmmVirtualMachineTemplate_Properties_DisksFields,
    ),
    ...
    "network_interfaces": ubx.FieldSpec(
        ...
        kind="list",
        fields=_ScvmmVirtualMachineTemplate_Properties_NetworkInterfacesFields,
    ),
...
@dataclasses.dataclass
class ScvmmVirtualMachineTemplateConfig:
...
@dataclasses.dataclass
class ScvmmVirtualMachineTemplateAttrs:
    # The extended location.
    extended_location: Any = None
    # Defines the resource properties.
    properties: Any = None

ScvmmVirtualMachineTemplate = ubx.ResourceBinding(
    wire_type="azure_scvmm_scvmm_virtual_machine_template",
    fields={
        "extended_location": ubx.FieldSpec(
            wire_name="extended_location",
            kind="object",
            fields=_ScvmmVirtualMachineTemplate_ExtendedLocationFields,
        ),
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_ScvmmVirtualMachineTemplate_PropertiesFields,
        ),
    },
)
