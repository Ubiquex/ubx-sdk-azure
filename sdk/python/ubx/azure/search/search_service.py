...
class SearchService_Identity_UserAssignedIdentities:
    client_id: Any = None
    principal_id: Any = None

@dataclasses.dataclass
class SearchService_Identity:
...
@dataclasses.dataclass
class SearchService_Properties_AuthOptions_AadOrApiKey:
    # Describes what response the data plane API of a search service would send for requests that failed authentication.
    aad_auth_failure_mode: Any = None

@dataclasses.dataclass
class SearchService_Properties_AuthOptions:
...
@dataclasses.dataclass
class SearchService_Properties_EncryptionWithCmk:
...
@dataclasses.dataclass
class SearchService_Properties_NetworkRuleSet_IpRules:
    value: Any = None

@dataclasses.dataclass
class SearchService_Properties_NetworkRuleSet:
...
@dataclasses.dataclass
class SearchService_Properties_PrivateEndpointConnections_Properties_PrivateEndpoint:
    id: Any = None

@dataclasses.dataclass
class SearchService_Properties_PrivateEndpointConnections_Properties_PrivateLinkServiceConnectionState:
    actions_required: Any = None
    description: Any = None
    status: Any = None

@dataclasses.dataclass
class SearchService_Properties_PrivateEndpointConnections_Properties:
    group_id: Any = None
...
@dataclasses.dataclass
class SearchService_Properties_PrivateEndpointConnections:
    properties: Any = None

@dataclasses.dataclass
class SearchService_Properties_SharedPrivateLinkResources_Properties:
    group_id: Any = None
...
@dataclasses.dataclass
class SearchService_Properties_SharedPrivateLinkResources:
    properties: Any = None

@dataclasses.dataclass
class SearchService_Properties:
...
_SearchService_Identity_UserAssignedIdentitiesFields = {
    "client_id": ubx.FieldSpec(wire_name="client_id"),
    "principal_id": ubx.FieldSpec(wire_name="principal_id"),
}

_SearchService_IdentityFields = {
    "principal_id": ubx.FieldSpec(wire_name="principal_id"),
    ...
    "user_assigned_identities": ubx.FieldSpec(
        ...
        kind="map",
        fields=_SearchService_Identity_UserAssignedIdentitiesFields,
    ),
}

_SearchService_Properties_AuthOptions_AadOrApiKeyFields = {
    "aad_auth_failure_mode": ubx.FieldSpec(wire_name="aad_auth_failure_mode"),
}

_SearchService_Properties_AuthOptionsFields = {
    "aad_or_api_key": ubx.FieldSpec(
        wire_name="aad_or_api_key",
        kind="object",
        fields=_SearchService_Properties_AuthOptions_AadOrApiKeyFields,
    ),
    "api_key_only": ubx.FieldSpec(wire_name="api_key_only"),
}

_SearchService_Properties_EncryptionWithCmkFields = {
...
_SearchService_Properties_NetworkRuleSet_IpRulesFields = {
    "value": ubx.FieldSpec(wire_name="value"),
}

_SearchService_Properties_NetworkRuleSetFields = {
    "bypass": ubx.FieldSpec(wire_name="bypass"),
    "ip_rules": ubx.FieldSpec(
        wire_name="ip_rules",
        kind="list",
        fields=_SearchService_Properties_NetworkRuleSet_IpRulesFields,
    ),
}

_SearchService_Properties_PrivateEndpointConnections_Properties_PrivateEndpointFields = {
    "id": ubx.FieldSpec(wire_name="id"),
}

_SearchService_Properties_PrivateEndpointConnections_Properties_PrivateLinkServiceConnectionStateFields = {
    "actions_required": ubx.FieldSpec(wire_name="actions_required"),
    "description": ubx.FieldSpec(wire_name="description"),
    "status": ubx.FieldSpec(wire_name="status"),
}

_SearchService_Properties_PrivateEndpointConnections_PropertiesFields = {
    "group_id": ubx.FieldSpec(wire_name="group_id"),
    "private_endpoint": ubx.FieldSpec(
        wire_name="private_endpoint",
        kind="object",
        fields=_SearchService_Properties_PrivateEndpointConnections_Properties_PrivateEndpointFields,
    ),
    "private_link_service_connection_state": ubx.FieldSpec(
        wire_name="private_link_service_connection_state",
        kind="object",
        fields=_SearchService_Properties_PrivateEndpointConnections_Properties_PrivateLinkServiceConnectionStateFields,
    ),
    "provisioning_state": ubx.FieldSpec(wire_name="provisioning_state"),
}

_SearchService_Properties_PrivateEndpointConnectionsFields = {
    "properties": ubx.FieldSpec(
        wire_name="properties",
        kind="object",
        fields=_SearchService_Properties_PrivateEndpointConnections_PropertiesFields,
    ),
}

_SearchService_Properties_SharedPrivateLinkResources_PropertiesFields = {
    "group_id": ubx.FieldSpec(wire_name="group_id"),
...
_SearchService_Properties_SharedPrivateLinkResourcesFields = {
    "properties": ubx.FieldSpec(
        wire_name="properties",
        kind="object",
        fields=_SearchService_Properties_SharedPrivateLinkResources_PropertiesFields,
    ),
}

_SearchService_PropertiesFields = {
    "auth_options": ubx.FieldSpec(
        wire_name="auth_options",
        kind="object",
        fields=_SearchService_Properties_AuthOptionsFields,
    ),
    ...
    "encryption_with_cmk": ubx.FieldSpec(
        ...
        kind="object",
        fields=_SearchService_Properties_EncryptionWithCmkFields,
    ),
    ...
    "network_rule_set": ubx.FieldSpec(
        ...
        kind="object",
        fields=_SearchService_Properties_NetworkRuleSetFields,
    ),
    ...
    "private_endpoint_connections": ubx.FieldSpec(
        ...
        kind="list",
        fields=_SearchService_Properties_PrivateEndpointConnectionsFields,
    ),
    "provisioning_state": ubx.FieldSpec(wire_name="provisioning_state"),
    ...
    "shared_private_link_resources": ubx.FieldSpec(
        ...
        kind="list",
        fields=_SearchService_Properties_SharedPrivateLinkResourcesFields,
    ),
    "status": ubx.FieldSpec(wire_name="status"),
...
SearchService = ubx.ResourceBinding(
    wire_type="azure_search_search_service",
    fields={
        "identity": ubx.FieldSpec(
            wire_name="identity",
            kind="object",
            fields=_SearchService_IdentityFields,
        ),
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_SearchService_PropertiesFields,
        ),
        "sku": ubx.FieldSpec(
            wire_name="sku",
            kind="object",
            fields=_SearchService_SkuFields,
        ),
    },
)
