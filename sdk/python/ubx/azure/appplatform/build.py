...
class Build_Properties_Apms:
    resource_id: Any = None

@dataclasses.dataclass
class Build_Properties_ResourceRequests:
...
@dataclasses.dataclass
class Build_Properties_TriggeredBuildResult:
...
_Build_PropertiesFields = {
    "agent_pool": ubx.FieldSpec(wire_name="agent_pool"),
    "apms": ubx.FieldSpec(
        wire_name="apms",
        kind="list",
        fields=_Build_Properties_ApmsFields,
    ),
    ...
    "resource_requests": ubx.FieldSpec(
        ...
        kind="object",
        fields=_Build_Properties_ResourceRequestsFields,
    ),
    "triggered_build_result": ubx.FieldSpec(
        wire_name="triggered_build_result",
        kind="object",
        fields=_Build_Properties_TriggeredBuildResultFields,
    ),
}
...
Build = ubx.ResourceBinding(
    wire_type="azure_appplatform_build",
    fields={
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_Build_PropertiesFields,
        ),
    },
)
