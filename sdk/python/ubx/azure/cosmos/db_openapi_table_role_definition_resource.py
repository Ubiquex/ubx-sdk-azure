...
class DbOpenapiTableRoleDefinitionResource_Properties_Permissions:
...
@dataclasses.dataclass
class DbOpenapiTableRoleDefinitionResource_Properties:
...
@dataclasses.dataclass
class DbOpenapiTableRoleDefinitionResourceConfig:
    # Azure Cosmos DB Table Role Definition resource object.
    properties: Any = None

@dataclasses.dataclass
class DbOpenapiTableRoleDefinitionResourceAttrs:
    # Azure Cosmos DB Table Role Definition resource object.
    properties: Any = None

DbOpenapiTableRoleDefinitionResource = ubx.ResourceBinding(
    wire_type="azure_cosmos_db_openapi_table_role_definition_resource",
    fields={
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_DbOpenapiTableRoleDefinitionResource_PropertiesFields,
        ),
    },
)
