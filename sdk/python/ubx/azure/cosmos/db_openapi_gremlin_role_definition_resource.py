...
class DbOpenapiGremlinRoleDefinitionResource_Properties_Permissions:
...
@dataclasses.dataclass
class DbOpenapiGremlinRoleDefinitionResource_Properties:
...
@dataclasses.dataclass
class DbOpenapiGremlinRoleDefinitionResourceConfig:
    # Azure Cosmos DB Gremlin Role Definition resource object.
    properties: Any = None

@dataclasses.dataclass
class DbOpenapiGremlinRoleDefinitionResourceAttrs:
    # Azure Cosmos DB Gremlin Role Definition resource object.
    properties: Any = None

DbOpenapiGremlinRoleDefinitionResource = ubx.ResourceBinding(
    wire_type="azure_cosmos_db_openapi_gremlin_role_definition_resource",
    fields={
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_DbOpenapiGremlinRoleDefinitionResource_PropertiesFields,
        ),
    },
)
