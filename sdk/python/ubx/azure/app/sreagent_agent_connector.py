...
class SreagentAgentConnector_Properties:
...
_SreagentAgentConnector_PropertiesFields = {
...
@dataclasses.dataclass
class SreagentAgentConnectorConfig:
    # Agent Connector Properties
    properties: Any = None

@dataclasses.dataclass
class SreagentAgentConnectorAttrs:
    # Agent Connector Properties
    properties: Any = None

SreagentAgentConnector = ubx.ResourceBinding(
    wire_type="azure_app_sreagent_agent_connector",
    fields={
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_SreagentAgentConnector_PropertiesFields,
        ),
    },
)
