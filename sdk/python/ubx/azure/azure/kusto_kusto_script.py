...
class KustoKustoScript_Properties:
...
_KustoKustoScript_PropertiesFields = {
...
@dataclasses.dataclass
class KustoKustoScriptConfig:
    # A class representing database script property.
    properties: Any = None

@dataclasses.dataclass
class KustoKustoScriptAttrs:
    # A class representing database script property.
    properties: Any = None

KustoKustoScript = ubx.ResourceBinding(
    wire_type="azure_azure_kusto_kusto_script",
    fields={
        "properties": ubx.FieldSpec(
            wire_name="properties",
            kind="object",
            fields=_KustoKustoScript_PropertiesFields,
        ),
    },
)
