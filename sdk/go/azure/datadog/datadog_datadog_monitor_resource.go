...
type DatadogDatadogMonitorResource_Identity struct {
	// The identity ID.
	PrincipalId any
...
type DatadogDatadogMonitorResource_Properties_DatadogOrganizationProperties struct {
...
type DatadogDatadogMonitorResource_Properties_UserInfo struct {
...
type DatadogDatadogMonitorResource_Properties struct {
...
type DatadogDatadogMonitorResource_Sku struct {
	// Name of the SKU in {PlanId} format. For Terraform, the only allowed value is 'Linked'.
	Name any
}

var DatadogDatadogMonitorResource_IdentityFields = ubx.FieldMap{
		"PrincipalId": ubx.FieldSpec{WireName: "principal_id"},
		"TenantId": ubx.FieldSpec{WireName: "tenant_id"},
		"Type": ubx.FieldSpec{WireName: "type"},
	}

var DatadogDatadogMonitorResource_Properties_DatadogOrganizationPropertiesFields = ubx.FieldMap{
...
var DatadogDatadogMonitorResource_Properties_UserInfoFields = ubx.FieldMap{
		"EmailAddress": ubx.FieldSpec{WireName: "email_address"},
		"Name": ubx.FieldSpec{WireName: "name"},
		"PhoneNumber": ubx.FieldSpec{WireName: "phone_number"},
	}

var DatadogDatadogMonitorResource_PropertiesFields = ubx.FieldMap{
...
var DatadogDatadogMonitorResource_SkuFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
	}

type DatadogDatadogMonitorResourceConfig struct {
	Identity any
...
type DatadogDatadogMonitorResourceAttrs struct {
	Identity any
	// Properties specific to the monitor resource.
	Properties any
	Sku any
...
var DatadogDatadogMonitorResource = ubx.ResourceBinding{
