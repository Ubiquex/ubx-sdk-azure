...
type ScriptExecution_Properties_HiddenParameters struct {
...
type ScriptExecution_Properties struct {
...
type ScriptExecutionAttrs struct {
	// Properties of a user-invoked script
	Properties any
}

var ScriptExecution = ubx.ResourceBinding{
