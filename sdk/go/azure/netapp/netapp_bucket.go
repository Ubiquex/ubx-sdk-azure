...
type NetappBucket_Properties_AkvDetails_CertificateAkvDetails struct {
...
type NetappBucket_Properties_AkvDetails_CredentialsAkvDetails struct {
...
type NetappBucket_Properties_AkvDetails struct {
...
type NetappBucket_Properties_FileSystemUser_CifsUser struct {
	// The CIFS user's username
	Username any
}

type NetappBucket_Properties_FileSystemUser_NfsUser struct {
	// The NFS user's GID
	GroupId any
	// The NFS user's UID
	UserId any
...
type NetappBucket_Properties_FileSystemUser struct {
...
type NetappBucket_Properties_Server struct {
...
type NetappBucket_Properties struct {
...
var NetappBucket_Properties_AkvDetails_CertificateAkvDetailsFields = ubx.FieldMap{
...
var NetappBucket_Properties_AkvDetails_CredentialsAkvDetailsFields = ubx.FieldMap{
		"CredentialsKeyVaultUri": ubx.FieldSpec{WireName: "credentials_key_vault_uri"},
		"SecretName": ubx.FieldSpec{WireName: "secret_name"},
	}

var NetappBucket_Properties_AkvDetailsFields = ubx.FieldMap{
...
var NetappBucket_Properties_FileSystemUser_CifsUserFields = ubx.FieldMap{
		"Username": ubx.FieldSpec{WireName: "username"},
	}

var NetappBucket_Properties_FileSystemUser_NfsUserFields = ubx.FieldMap{
		"GroupId": ubx.FieldSpec{WireName: "group_id"},
		"UserId": ubx.FieldSpec{WireName: "user_id"},
	}

var NetappBucket_Properties_FileSystemUserFields = ubx.FieldMap{
...
var NetappBucket_Properties_ServerFields = ubx.FieldMap{
...
var NetappBucket_PropertiesFields = ubx.FieldMap{
...
type NetappBucketConfig struct {
	// Bucket resource properties
	Properties any
}

type NetappBucketAttrs struct {
	// Bucket resource properties
	Properties any
}

var NetappBucket = ubx.ResourceBinding{
