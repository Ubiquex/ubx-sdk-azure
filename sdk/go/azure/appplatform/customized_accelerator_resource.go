...
type CustomizedAcceleratorResource_Properties_GitRepository_AuthSetting struct {
	// The type of the auth setting.
	AuthType any
}

type CustomizedAcceleratorResource_Properties_GitRepository struct {
...
type CustomizedAcceleratorResource_Sku struct {
...
var CustomizedAcceleratorResource = ubx.ResourceBinding{
