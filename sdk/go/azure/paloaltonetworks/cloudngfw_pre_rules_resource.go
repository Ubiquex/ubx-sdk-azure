...
type CloudngfwPreRulesResource_Properties_Category struct {
	// feed list
	Feeds any
	// custom URL
	UrlCustom any
...
type CloudngfwPreRulesResource_Properties_Destination struct {
	// special value 'any'
	Cidrs any
	// list of countries
	Countries any
...
type CloudngfwPreRulesResource_Properties_Source struct {
	// special value 'any'
	Cidrs any
	// list of countries
	Countries any
...
type CloudngfwPreRulesResource_Properties_Tags struct {
...
type CloudngfwPreRulesResource_Properties struct {
...
var CloudngfwPreRulesResource_Properties_CategoryFields = ubx.FieldMap{
	"Feeds":     ubx.FieldSpec{WireName: "feeds"},
	"UrlCustom": ubx.FieldSpec{WireName: "url_custom"},
}

var CloudngfwPreRulesResource_Properties_DestinationFields = ubx.FieldMap{
...
var CloudngfwPreRulesResource_Properties_SourceFields = ubx.FieldMap{
	"Cidrs":       ubx.FieldSpec{WireName: "cidrs"},
	"Countries":   ubx.FieldSpec{WireName: "countries"},
	"Feeds":       ubx.FieldSpec{WireName: "feeds"},
	"PrefixLists": ubx.FieldSpec{WireName: "prefix_lists"},
...
var CloudngfwPreRulesResource_Properties_TagsFields = ubx.FieldMap{
	"Key":   ubx.FieldSpec{WireName: "key"},
	"Value": ubx.FieldSpec{WireName: "value"},
}

var CloudngfwPreRulesResource_PropertiesFields = ubx.FieldMap{
...
var CloudngfwPreRulesResource = ubx.ResourceBinding{
