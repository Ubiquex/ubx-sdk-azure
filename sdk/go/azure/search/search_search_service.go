...
type SearchSearchService_Identity_UserAssignedIdentities struct {
	ClientId any
	PrincipalId any
}

type SearchSearchService_Identity struct {
...
type SearchSearchService_Properties_AuthOptions_AadOrApiKey struct {
	// Describes what response the data plane API of a search service would send for requests that failed authentication.
	AadAuthFailureMode any
}

type SearchSearchService_Properties_AuthOptions struct {
...
type SearchSearchService_Properties_EncryptionWithCmk struct {
...
type SearchSearchService_Properties_NetworkRuleSet_IpRules struct {
	Value any
}

type SearchSearchService_Properties_NetworkRuleSet struct {
...
type SearchSearchService_Properties_PrivateEndpointConnections_Properties_PrivateEndpoint struct {
	Id any
}

type SearchSearchService_Properties_PrivateEndpointConnections_Properties_PrivateLinkServiceConnectionState struct {
	ActionsRequired any
	Description any
	Status any
}

type SearchSearchService_Properties_PrivateEndpointConnections_Properties struct {
	GroupId any
	PrivateEndpoint any
...
type SearchSearchService_Properties_PrivateEndpointConnections struct {
	Properties any
}

type SearchSearchService_Properties_SharedPrivateLinkResources_Properties struct {
	GroupId any
...
type SearchSearchService_Properties_SharedPrivateLinkResources struct {
	Properties any
}

type SearchSearchService_Properties struct {
...
type SearchSearchService_Sku struct {
...
var SearchSearchService_Identity_UserAssignedIdentitiesFields = ubx.FieldMap{
		"ClientId": ubx.FieldSpec{WireName: "client_id"},
		"PrincipalId": ubx.FieldSpec{WireName: "principal_id"},
	}

var SearchSearchService_IdentityFields = ubx.FieldMap{
		"PrincipalId": ubx.FieldSpec{WireName: "principal_id"},
...
var SearchSearchService_Properties_AuthOptions_AadOrApiKeyFields = ubx.FieldMap{
		"AadAuthFailureMode": ubx.FieldSpec{WireName: "aad_auth_failure_mode"},
	}

var SearchSearchService_Properties_AuthOptionsFields = ubx.FieldMap{
...
var SearchSearchService_Properties_EncryptionWithCmkFields = ubx.FieldMap{
...
var SearchSearchService_Properties_NetworkRuleSet_IpRulesFields = ubx.FieldMap{
		"Value": ubx.FieldSpec{WireName: "value"},
	}

var SearchSearchService_Properties_NetworkRuleSetFields = ubx.FieldMap{
...
var SearchSearchService_Properties_PrivateEndpointConnections_Properties_PrivateEndpointFields = ubx.FieldMap{
		"Id": ubx.FieldSpec{WireName: "id"},
	}

var SearchSearchService_Properties_PrivateEndpointConnections_Properties_PrivateLinkServiceConnectionStateFields = ubx.FieldMap{
		"ActionsRequired": ubx.FieldSpec{WireName: "actions_required"},
		"Description": ubx.FieldSpec{WireName: "description"},
		"Status": ubx.FieldSpec{WireName: "status"},
	}

var SearchSearchService_Properties_PrivateEndpointConnections_PropertiesFields = ubx.FieldMap{
...
var SearchSearchService_Properties_PrivateEndpointConnectionsFields = ubx.FieldMap{
...
var SearchSearchService_Properties_SharedPrivateLinkResources_PropertiesFields = ubx.FieldMap{
		"GroupId": ubx.FieldSpec{WireName: "group_id"},
...
var SearchSearchService_Properties_SharedPrivateLinkResourcesFields = ubx.FieldMap{
		"Properties": ubx.FieldSpec{
			WireName: "properties",
			Kind: "object",
...
var SearchSearchService_PropertiesFields = ubx.FieldMap{
...
var SearchSearchService_SkuFields = ubx.FieldMap{
		"Name": ubx.FieldSpec{WireName: "name"},
	}

type SearchSearchServiceConfig struct {
...
type SearchSearchServiceAttrs struct {
	// Details about the search service identity. A null value indicates that the search service has no identity assigned.
	Identity any
	// Properties of the search service.
	Properties any
...
var SearchSearchService = ubx.ResourceBinding{
