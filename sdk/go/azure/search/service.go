...
type Service_Properties_AuthOptions_AadOrApiKey struct {
	// Describes what response the data plane API of a search service would send for requests that failed authentication.
	AadAuthFailureMode any
}

type Service_Properties_AuthOptions struct {
...
type Service_Properties_EncryptionWithCmk struct {
...
type Service_Properties_NetworkRuleSet_IpRules struct {
	Value any
}

type Service_Properties_NetworkRuleSet struct {
...
type Service_Properties_PrivateEndpointConnections_Properties_PrivateEndpoint struct {
	Id any
}
...
type Service_Properties struct {
