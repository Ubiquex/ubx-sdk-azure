...
type SearchSharedPrivateLinkResource_Properties struct {
...
var SearchSharedPrivateLinkResource_PropertiesFields = ubx.FieldMap{
...
type SearchSharedPrivateLinkResourceConfig struct {
	// Describes the properties of an existing shared private link resource managed by the Azure AI Search service.
	Properties any
}

type SearchSharedPrivateLinkResourceAttrs struct {
	// Describes the properties of an existing shared private link resource managed by the Azure AI Search service.
	Properties any
}

var SearchSharedPrivateLinkResource = ubx.ResourceBinding{
