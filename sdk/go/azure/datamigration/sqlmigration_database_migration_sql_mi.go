...
type SqlmigrationDatabaseMigrationSqlMi_Properties_BackupConfiguration_SourceLocation_AzureBlob_Identity struct {
...
type SqlmigrationDatabaseMigrationSqlMi_Properties_BackupConfiguration_SourceLocation_AzureBlob struct {
	// Storage Account Key.
	AccountKey any
...
type SqlmigrationDatabaseMigrationSqlMi_Properties_BackupConfiguration_SourceLocation_FileShare struct {
...
type SqlmigrationDatabaseMigrationSqlMi_Properties_BackupConfiguration_SourceLocation struct {
	// Azure Blob Details
	AzureBlob any
	// File share
	FileShare any
...
type SqlmigrationDatabaseMigrationSqlMi_Properties_BackupConfiguration_TargetLocation struct {
	// Storage Account Key.
	AccountKey any
...
type SqlmigrationDatabaseMigrationSqlMi_Properties_BackupConfiguration struct {
...
type SqlmigrationDatabaseMigrationSqlMi_Properties_OfflineConfiguration struct {
...
type SqlmigrationDatabaseMigrationSqlMi_Properties struct {
...
type SqlmigrationDatabaseMigrationSqlMiAttrs struct {
	// Database Migration Resource properties for SQL Managed Instance.
	Properties any
}

var SqlmigrationDatabaseMigrationSqlMi = ubx.ResourceBinding{
