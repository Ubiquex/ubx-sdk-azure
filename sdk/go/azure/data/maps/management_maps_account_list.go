...
type ManagementMapsAccountList_Value_Properties_Cors_CorsRules struct {
	AllowedOrigins any
}

type ManagementMapsAccountList_Value_Properties_Cors struct {
	CorsRules any
}
...
type ManagementMapsAccountListConfig struct {
}

type ManagementMapsAccountListAttrs struct {
