...
type AccountList_Value_Properties_AbusePenalty struct {
	Action any
	Expiration any
	RateLimitPercentage any
}

type AccountList_Value_Properties_AmlWorkspace struct {
	IdentityClientId any
	ResourceId any
}

type AccountList_Value_Properties_ApiProperties struct {
	AadClientId any
	AadTenantId any
...
type AccountList_Value_Properties_CallRateLimit_Rules_MatchPatterns struct {
	Method any
	Path any
}

type AccountList_Value_Properties_CallRateLimit_Rules struct {
	Count any
...
type AccountList_Value_Properties_CallRateLimit struct {
	Count any
	RenewalPeriod any
	Rules any
}

type AccountList_Value_Properties_Capabilities struct {
	Name any
	Value any
}

type AccountList_Value_Properties_CommitmentPlanAssociations struct {
	CommitmentPlanId any
	CommitmentPlanLocation any
}

type AccountList_Value_Properties_Encryption_KeyVaultProperties struct {
	IdentityClientId any
	KeyName any
	KeyVaultUri any
	KeyVersion any
...
type AccountList_Value_Properties_Encryption struct {
	KeySource any
	KeyVaultProperties any
}

type AccountList_Value_Properties_Locations_Regions struct {
	Customsubdomain any
	Name any
	Value any
}

type AccountList_Value_Properties_Locations struct {
	Regions any
	RoutingMethod any
}

type AccountList_Value_Properties_NetworkAcls_IpRules struct {
	Value any
}

type AccountList_Value_Properties_NetworkAcls_VirtualNetworkRules struct {
	Id any
	IgnoreMissingVnetServiceEndpoint any
	State any
}

type AccountList_Value_Properties_NetworkAcls struct {
	Bypass any
	DefaultAction any
	IpRules any
...
type AccountList_Value_Properties_NetworkInjections struct {
	Scenario any
	SubnetArmId any
...
type AccountList_Value_Properties_RaiMonitorConfig struct {
	AdxStorageResourceId any
	IdentityClientId any
}

type AccountList_Value_Properties_SkuChangeInfo struct {
