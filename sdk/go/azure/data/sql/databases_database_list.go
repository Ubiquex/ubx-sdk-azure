...
type DatabasesDatabaseList_Value_Identity_UserAssignedIdentities struct {
	ClientId    any
	PrincipalId any
}

type DatabasesDatabaseList_Value_Identity struct {
	TenantId               any
	Type                   any
	UserAssignedIdentities any
}

type DatabasesDatabaseList_Value_Properties_CurrentSku struct {
	Capacity any
	Family   any
	Name     any
	Size     any
...
type DatabasesDatabaseList_Value_Properties_Keys struct {
	CreationDate any
	KeyVersion   any
	Subregion    any
	Thumbprint   any
...
type DatabasesDatabaseList_Value_Properties struct {
	AutoPauseDelay                    any
...
type DatabasesDatabaseList_Value struct {
	Identity   any
	Kind       any
	ManagedBy  any
	Properties any
...
type DatabasesDatabaseListConfig struct {
	ServerName any
}

type DatabasesDatabaseListAttrs struct {
...
var DatabasesDatabaseList = ubx.DataSourceBinding{
