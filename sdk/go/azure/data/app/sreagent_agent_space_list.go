...
type SreagentAgentSpaceList_Value_Properties_Policies_GenevaActionsConfiguration_AllowedActions_ActionParameters struct {
	Name any
	Type any
}
...
type SreagentAgentSpaceListConfig struct {
}

type SreagentAgentSpaceListAttrs struct {
