...
type DtlLabVirtualMachineList_Value_Properties_ApplicableSchedule_Properties_LabVmsShutdown_Properties_DailyRecurrence struct {
	Time any
}

type DtlLabVirtualMachineList_Value_Properties_ApplicableSchedule_Properties_LabVmsShutdown_Properties_HourlyRecurrence struct {
	Minute any
}
...
type DtlLabVirtualMachineList_Value_Properties_NetworkInterface_SharedPublicIpAddressConfiguration struct {
	InboundNatRules any
}
...
type DtlLabVirtualMachineListAttrs struct {
	LabName any
...
var DtlLabVirtualMachineList = ubx.DataSourceBinding{
