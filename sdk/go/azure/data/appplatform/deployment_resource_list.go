...
type DeploymentResourceList_Value_Properties_DeploymentSettings_Apms struct {
	ResourceId any
}

type DeploymentResourceList_Value_Properties_DeploymentSettings_ContainerProbeSettings struct {
	DisableProbe any
}

type DeploymentResourceList_Value_Properties_DeploymentSettings_LivenessProbe_ProbeAction struct {
	Type any
}
