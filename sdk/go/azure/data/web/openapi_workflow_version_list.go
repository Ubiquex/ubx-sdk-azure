...
type OpenapiWorkflowVersionList_Value_Properties_AccessControl_Actions_AllowedCallerIpAddresses struct {
	AddressRange any
}
...
type OpenapiWorkflowVersionList_Value_Properties_EndpointsConfiguration_Connector_AccessEndpointIpAddresses struct {
	Address any
}
...
type OpenapiWorkflowVersionListAttrs struct {
	Name any
