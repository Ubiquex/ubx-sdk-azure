...
type ReplicaList_Value_Properties_Administrator struct {
	Password any
	UserName any
}

type ReplicaList_Value_Properties_AuthConfig struct {
	AllowedModes any
}

type ReplicaList_Value_Properties_Backup struct {
	EarliestRestoreTime any
}

type ReplicaList_Value_Properties_Compute struct {
	Tier any
}

type ReplicaList_Value_Properties_DataApi struct {
	Mode any
}
...
type ReplicaList_Value_Properties_HighAvailability struct {
	TargetMode any
}

type ReplicaList_Value_Properties_PrivateEndpointConnections_Properties_PrivateEndpoint struct {
	Id any
}
...
type ReplicaList_Value_Properties_Sharding struct {
	ShardCount any
}
