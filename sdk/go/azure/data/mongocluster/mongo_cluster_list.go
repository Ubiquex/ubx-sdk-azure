...
type MongoClusterList_Value_Properties_Administrator struct {
	Password any
	UserName any
}

type MongoClusterList_Value_Properties_AuthConfig struct {
	AllowedModes any
}

type MongoClusterList_Value_Properties_Backup struct {
	EarliestRestoreTime any
}

type MongoClusterList_Value_Properties_Compute struct {
	Tier any
}

type MongoClusterList_Value_Properties_DataApi struct {
	Mode any
}
...
type MongoClusterList_Value_Properties_HighAvailability struct {
	TargetMode any
}

type MongoClusterList_Value_Properties_PrivateEndpointConnections_Properties_PrivateEndpoint struct {
	Id any
}
...
type MongoClusterList_Value_Properties_Sharding struct {
	ShardCount any
}
...
type MongoClusterListConfig struct {
}

type MongoClusterListAttrs struct {
