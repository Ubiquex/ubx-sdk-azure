...
type Cluster_Value_Properties_ComputeProfile_Roles_Autoscale_Recurrence struct {
	Schedule any
	TimeZone any
}
...
type Cluster_Value_Properties_ComputeProfile_Roles_HardwareProfile struct {
	VmSize any
}

type Cluster_Value_Properties_ComputeProfile_Roles_OsProfile_LinuxOperatingSystemProfile_SshProfile_PublicKeys struct {
	CertificateData any
}

type Cluster_Value_Properties_ComputeProfile_Roles_OsProfile_LinuxOperatingSystemProfile_SshProfile struct {
	PublicKeys any
}
