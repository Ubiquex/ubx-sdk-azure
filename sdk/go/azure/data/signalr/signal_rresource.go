...
type SignalRresource_Value_Properties_Cors struct {
	AllowedOrigins any
}
...
type SignalRresource_Value_Properties_ResourceLogConfiguration struct {
	Categories any
}

type SignalRresource_Value_Properties_Serverless struct {
...
type SignalRresource_Value_Properties_Tls struct {
	ClientCertEnabled any
}

type SignalRresource_Value_Properties_Upstream_Templates_Auth_ManagedIdentity struct {
	Resource any
}
