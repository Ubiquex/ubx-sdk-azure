...
type OpenapiRegistry_Value_Properties_ManagedResourceGroup struct {
	ResourceId any
}

type OpenapiRegistry_Value_Properties_ManagedResourceGroupSettings_AssignedIdentities struct {
	PrincipalId any
}

type OpenapiRegistry_Value_Properties_ManagedResourceGroupSettings struct {
...
type OpenapiRegistry_Value_Properties_RegistryPrivateEndpointConnections_Properties_PrivateEndpoint struct {
	SubnetArmId any
}
