...
type OpenapiBillingRequestList_Value_Properties_CreatedBy struct {
	ObjectId any
	TenantId any
	Upn      any
}

type OpenapiBillingRequestList_Value_Properties struct {
...
type OpenapiBillingRequestList_Value struct {
	Properties any
	Tags       any
}

type OpenapiBillingRequestListConfig struct {
	BillingAccountName any
	BillingProfileName any
	Count              any
	Filter             any
...
type OpenapiBillingRequestListAttrs struct {
	BillingAccountName any
	BillingProfileName any
	Count              any
	Filter             any
...
var OpenapiBillingRequestList = ubx.DataSourceBinding{
