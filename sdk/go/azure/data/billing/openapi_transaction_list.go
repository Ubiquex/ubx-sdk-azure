...
type OpenapiTransactionList_Value_Properties_AzureCreditApplied struct {
	Currency any
	Value any
}

type OpenapiTransactionList_Value_Properties_RefundTransactionDetails struct {
	AmountRefunded any
	AmountRequested any
	RefundOperationId any
}

type OpenapiTransactionList_Value_Properties struct {
...
type OpenapiTransactionList_Value struct {
	Properties any
}

type OpenapiTransactionListConfig struct {
...
type OpenapiTransactionListAttrs struct {
	BillingAccountName any
	BillingProfileName any
	Count any
	CustomerName any
...
var OpenapiTransactionList = ubx.DataSourceBinding{
