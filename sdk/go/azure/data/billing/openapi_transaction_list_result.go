...
type OpenapiTransactionListResult_Value_Properties_AzureCreditApplied struct {
	Currency any
	Value any
}

type OpenapiTransactionListResult_Value_Properties_RefundTransactionDetails struct {
	AmountRefunded any
	AmountRequested any
	RefundOperationId any
}

type OpenapiTransactionListResult_Value_Properties struct {
...
type OpenapiTransactionListResult_Value struct {
	Properties any
}

type OpenapiTransactionListResultConfig struct {
...
type OpenapiTransactionListResultAttrs struct {
	BillingAccountName any
	BillingProfileName any
	Count any
	CustomerName any
...
var OpenapiTransactionListResult = ubx.DataSourceBinding{
