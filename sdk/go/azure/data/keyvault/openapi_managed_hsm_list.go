...
type OpenapiManagedHsmList_Value_Properties_NetworkAcls_IpRules struct {
	Value any
}

type OpenapiManagedHsmList_Value_Properties_NetworkAcls_ServiceTags struct {
	Tag any
}

type OpenapiManagedHsmList_Value_Properties_NetworkAcls_VirtualNetworkRules struct {
	Id any
}
...
type OpenapiManagedHsmListAttrs struct {
