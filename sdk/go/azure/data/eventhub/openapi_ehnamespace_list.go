...
type OpenapiEhnamespaceList_Value_Properties_Encryption_KeyVaultProperties_Identity struct {
...
type OpenapiEhnamespaceList_Value_Properties_GeoDataReplication_Locations struct {
	ClusterArmId any
	LocationName any
	ReplicaState any
	RoleType     any
...
type OpenapiEhnamespaceList_Value_Properties_PlatformCapabilities_ConfidentialCompute struct {
	Mode any
}

type OpenapiEhnamespaceList_Value_Properties_PlatformCapabilities struct {
	ConfidentialCompute any
}

type OpenapiEhnamespaceList_Value_Properties_PrivateEndpointConnections_Properties_PrivateEndpoint struct {
	Id any
}
...
type OpenapiEhnamespaceListAttrs struct {
