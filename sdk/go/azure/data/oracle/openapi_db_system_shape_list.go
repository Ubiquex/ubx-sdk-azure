...
type OpenapiDbSystemShapeList_Value_Properties struct {
...
type OpenapiDbSystemShapeList_Value struct {
	Properties any
}

type OpenapiDbSystemShapeListConfig struct {
	ShapeAttribute any
	Zone           any
}

type OpenapiDbSystemShapeListAttrs struct {
...
var OpenapiDbSystemShapeList = ubx.DataSourceBinding{
