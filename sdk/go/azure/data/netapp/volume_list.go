...
type VolumeList_Value_Properties_DataProtection_Backup struct {
	BackupPolicyId any
	BackupVaultId any
	PolicyEnforced any
}

type VolumeList_Value_Properties_DataProtection_RansomwareProtection struct {
	ActualRansomwareProtectionState any
	DesiredRansomwareProtectionState any
}

type VolumeList_Value_Properties_DataProtection_Replication_DestinationReplications struct {
	Region any
	ReplicationType any
	ResourceId any
	Zone any
...
type VolumeList_Value_Properties_DataProtection_Replication_RemotePath struct {
	ExternalHostName any
	ServerName any
	VolumeName any
}

type VolumeList_Value_Properties_DataProtection_Replication struct {
...
type VolumeList_Value_Properties_DataProtection_Snapshot struct {
	SnapshotPolicyId any
}

type VolumeList_Value_Properties_DataProtection_VolumeRelocation struct {
	ReadyToBeFinalized any
	RelocationRequested any
}

type VolumeList_Value_Properties_DataProtection struct {
	Backup any
...
type VolumeList_Value_Properties_ExportPolicy_Rules struct {
	AllowedClients any
	ChownMode any
	Cifs any
	HasRootAccess any
...
type VolumeList_Value_Properties_ExportPolicy struct {
	Rules any
}

type VolumeList_Value_Properties_MountTargets struct {
	FileSystemId any
	IpAddress any
	MountTargetId any
	SmbServerFqdn any
...
type VolumeList_Value_Properties_PlacementRules struct {
	Key any
	Value any
}

type VolumeList_Value_Properties struct {
...
var VolumeList = ubx.DataSourceBinding{
