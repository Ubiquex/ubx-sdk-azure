...
type PartnerNamespaceList_Value_Properties_InboundIpRules struct {
	Action any
	IpMask any
}

type PartnerNamespaceList_Value_Properties_PrivateEndpointConnections_Properties_PrivateEndpoint struct {
	Id any
}
...
type PartnerNamespaceList_Value struct {
	Properties any
	SystemData any
}
