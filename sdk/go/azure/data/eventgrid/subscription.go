...
type Subscription_Value_Properties_DeliveryConfiguration_Push_DeadLetterDestinationWithResourceIdentity_DeadLetterDestination struct {
	EndpointType any
}
...
type Subscription_Value struct {
	Properties any
	SystemData any
}
