...
type Sbnamespace_Value_Properties_Encryption_KeyVaultProperties_Identity struct {
...
type Sbnamespace_Value_Properties_PlatformCapabilities_ConfidentialCompute struct {
	Mode any
}

type Sbnamespace_Value_Properties_PlatformCapabilities struct {
	ConfidentialCompute any
}

type Sbnamespace_Value_Properties_PrivateEndpointConnections_Properties_PrivateEndpoint struct {
	Id any
}
