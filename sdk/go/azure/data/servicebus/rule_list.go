...
type RuleList_Value_Properties_Action struct {
	CompatibilityLevel any
	RequiresPreprocessing any
	SqlExpression any
}

type RuleList_Value_Properties_CorrelationFilter struct {
	ContentType any
	CorrelationId any
	Label any
	MessageId any
...
type RuleList_Value_Properties struct {
	Action any
