...
type SbqueueList_Value_Properties_CountDetails struct {
...
type SbqueueList_Value_Properties struct {
	AccessedAt                          any
...
type SbqueueList_Value struct {
	Location   any
	Properties any
}

type SbqueueListConfig struct {
	NamespaceName any
}

type SbqueueListAttrs struct {
	NamespaceName any
...
var SbqueueList = ubx.DataSourceBinding{
