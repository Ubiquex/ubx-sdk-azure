...
type SbsubscriptionList_Value_Properties_ClientAffineProperties struct {
	ClientId  any
	IsDurable any
	IsShared  any
}

type SbsubscriptionList_Value_Properties_CountDetails struct {
...
type SbsubscriptionList_Value_Properties struct {
	AccessedAt                                any
...
type SbsubscriptionList_Value struct {
	Location   any
	Properties any
}

type SbsubscriptionListConfig struct {
	NamespaceName any
	TopicName     any
}

type SbsubscriptionListAttrs struct {
	NamespaceName any
...
var SbsubscriptionList = ubx.DataSourceBinding{
