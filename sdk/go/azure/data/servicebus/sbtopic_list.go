...
type SbtopicList_Value_Properties_CountDetails struct {
...
type SbtopicList_Value_Properties struct {
	AccessedAt any
...
type SbtopicList_Value struct {
	Location any
	Properties any
}

type SbtopicListConfig struct {
	NamespaceName any
}

type SbtopicListAttrs struct {
	NamespaceName any
...
var SbtopicList = ubx.DataSourceBinding{
