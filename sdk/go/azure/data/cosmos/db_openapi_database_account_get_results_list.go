...
type DbOpenapiDatabaseAccountGetResultsList_Value_Properties_AnalyticalStorageConfiguration struct {
	SchemaType any
}

type DbOpenapiDatabaseAccountGetResultsList_Value_Properties_ApiProperties struct {
	ServerVersion any
}
...
type DbOpenapiDatabaseAccountGetResultsList_Value_Properties_Capacity struct {
...
type DbOpenapiDatabaseAccountGetResultsList_Value_Properties_KeysMetadata_PrimaryMasterKey struct {
	GenerationTime any
}
...
type DbOpenapiDatabaseAccountGetResultsList_Value_Properties_PrivateEndpointConnections_Properties_PrivateEndpoint struct {
	Id any
}
...
type DbOpenapiDatabaseAccountGetResultsListAttrs struct {
	NextLink any
