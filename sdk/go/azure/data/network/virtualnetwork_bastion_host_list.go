...
type VirtualnetworkBastionHostList_Value_Properties_IpConfigurations_Properties_PublicIpaddress struct {
	Id any
}
...
type VirtualnetworkBastionHostList_Value_Properties_NetworkAcls struct {
	IpRules any
}
...
type VirtualnetworkBastionHostListAttrs struct {
