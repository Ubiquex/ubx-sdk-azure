...
type ManagedclustersManagedCluster_Value_ExtendedLocation struct {
	Name any
	Type any
}
...
type ManagedclustersManagedCluster_Value_Properties_AgentPoolProfiles struct {
	Name any
}

type ManagedclustersManagedCluster_Value_Properties_AiToolchainOperatorProfile struct {
	Enabled any
}
...
type ManagedclustersManagedCluster_Value_Properties_IngressProfile_WebAppRouting_GatewayApiimplementations_AppRoutingIstio struct {
	Mode any
}

type ManagedclustersManagedCluster_Value_Properties_IngressProfile_WebAppRouting_GatewayApiimplementations struct {
	AppRoutingIstio any
}

type ManagedclustersManagedCluster_Value_Properties_IngressProfile_WebAppRouting_Nginx struct {
...
type ManagedclustersManagedCluster_Value_Properties_LinuxProfile_Ssh_PublicKeys struct {
	KeyData any
}

type ManagedclustersManagedCluster_Value_Properties_LinuxProfile_Ssh struct {
	PublicKeys any
}
...
type ManagedclustersManagedCluster_Value_Properties_NetworkProfile_AdvancedNetworking_Performance struct {
	AccelerationMode any
}

type ManagedclustersManagedCluster_Value_Properties_NetworkProfile_AdvancedNetworking_Security_TransitEncryption struct {
	Type any
}
...
type ManagedclustersManagedCluster_Value_Properties_NetworkProfile_LoadBalancerProfile_OutboundIpprefixes struct {
	PublicIpprefixes any
}

type ManagedclustersManagedCluster_Value_Properties_NetworkProfile_LoadBalancerProfile_OutboundIps struct {
	PublicIps any
}
...
type ManagedclustersManagedCluster_Value_Properties_PodIdentityProfile_UserAssignedIdentities_ProvisioningInfo_Error_Error_Details struct {
}
...
type ManagedclustersManagedCluster_Value_Properties_PodIdentityProfile_UserAssignedIdentities_ProvisioningInfo struct {
	Error any
}
...
type ManagedclustersManagedCluster_Value_Properties_PowerState struct {
	Code any
}
...
type ManagedclustersManagedCluster_Value_Properties_SchedulerProfile struct {
	Upstream any
}
