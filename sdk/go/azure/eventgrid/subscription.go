...
type Subscription_Properties_DeliveryConfiguration_Push_DeadLetterDestinationWithResourceIdentity_DeadLetterDestination struct {
	// Type of the endpoint for the dead letter destination
	EndpointType any
}

type Subscription_Properties_DeliveryConfiguration_Push_DeadLetterDestinationWithResourceIdentity_Identity struct {
...
type Subscription_Properties_DeliveryConfiguration_Push_DeadLetterDestinationWithResourceIdentity struct {
...
type Subscription_Properties_DeliveryConfiguration_Push_DeliveryWithResourceIdentity struct {
...
type Subscription_Properties_DeliveryConfiguration_Push struct {
...
type Subscription_Properties_DeliveryConfiguration_Queue struct {
	// Information about the deadletter destination with resource identity.
	DeadLetterDestinationWithResourceIdentity any
	// Time span duration in ISO 8601 format that determines how long messages are available to the subscription from the time the message was published. This duration value is expressed using the following format: \'P(n)Y(n)M(n)DT(n)H(n)M(n)S\', where: - (n) is replaced by the value of each time element that follows the (n). - P is the duration (or Period) designator and is always placed at the beginning of the duration. - Y is the year designator, and it follows the value for the number of years. - M is the month designator, and it follows the value for the number of months. - W is the week designator, and it follows the value for the number of weeks. - D is the day designator, and it follows the value for the number of days. - T is the time designator, and it precedes the time components. - H is the hour designator, and it follows the value for the number of hours. - M is the minute designator, and it follows the value for the number of minutes. - S is the second designator, and it follows the value for the number of seconds. This duration value cannot be set greater than the topic’s EventRetentionInDays. It is is an optional field where its minimum value is 1 minute, and its maximum is determined by topic’s EventRetentionInDays value. The followings are examples of valid values: - \'P0DT23H12M\' or \'PT23H12M\': for duration of 23 hours and 12 minutes. - \'P1D\' or \'P1DT0H0M0S\': for duration of 1 day.
	EventTimeToLive any
...
type Subscription_Properties_DeliveryConfiguration struct {
...
type Subscription_Properties_FiltersConfiguration struct {
...
type Subscription_Properties struct {
...
type Subscription_SystemData struct {
...
var Subscription_Properties_DeliveryConfiguration_Push_DeadLetterDestinationWithResourceIdentity_DeadLetterDestinationFields = ubx.FieldMap{
		"EndpointType": ubx.FieldSpec{WireName: "endpoint_type"},
	}

var Subscription_Properties_DeliveryConfiguration_Push_DeadLetterDestinationWithResourceIdentity_IdentityFields = ubx.FieldMap{
		"Type": ubx.FieldSpec{WireName: "type"},
		"UserAssignedIdentity": ubx.FieldSpec{WireName: "user_assigned_identity"},
	}

var Subscription_Properties_DeliveryConfiguration_Push_DeadLetterDestinationWithResourceIdentityFields = ubx.FieldMap{
...
var Subscription_Properties_DeliveryConfiguration_Push_DeliveryWithResourceIdentityFields = ubx.FieldMap{
...
var Subscription_Properties_DeliveryConfiguration_PushFields = ubx.FieldMap{
...
var Subscription_Properties_DeliveryConfiguration_QueueFields = ubx.FieldMap{
		"DeadLetterDestinationWithResourceIdentity": ubx.FieldSpec{
			WireName: "dead_letter_destination_with_resource_identity",
			Kind: "object",
			Fields: Subscription_Properties_DeliveryConfiguration_Push_DeadLetterDestinationWithResourceIdentityFields,
...
var Subscription_Properties_DeliveryConfigurationFields = ubx.FieldMap{
...
var Subscription_Properties_FiltersConfiguration_FiltersFields = ubx.FieldMap{
		"Key": ubx.FieldSpec{WireName: "key"},
		"OperatorType": ubx.FieldSpec{WireName: "operator_type"},
	}

var Subscription_Properties_FiltersConfigurationFields = ubx.FieldMap{
...
var Subscription_PropertiesFields = ubx.FieldMap{
...
var Subscription_SystemDataFields = ubx.FieldMap{
