...
type ApimsubscriptionsSubscriptionContract2_Properties struct {
...
type ApimsubscriptionsSubscriptionContract2Attrs struct {
	// Parameters supplied to the Create subscription operation.
	Properties any
	// path parameter, not part of the API's own resource representation
	Sid any
...
var ApimsubscriptionsSubscriptionContract2 = ubx.ResourceBinding{
