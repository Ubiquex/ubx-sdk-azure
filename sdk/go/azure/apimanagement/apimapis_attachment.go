...
type ApimapisAttachment_Properties_WsdlSelector struct {
...
type ApimapisAttachment_Properties struct {
...
var ApimapisAttachment_Properties_WsdlSelectorFields = ubx.FieldMap{
		"WsdlEndpointName": ubx.FieldSpec{WireName: "wsdl_endpoint_name"},
		"WsdlServiceName": ubx.FieldSpec{WireName: "wsdl_service_name"},
	}

var ApimapisAttachment_PropertiesFields = ubx.FieldMap{
...
type ApimapisAttachmentConfig struct {
	// API Create or Update Properties.
	Properties any
}

type ApimapisAttachmentAttrs struct {
	// API Create or Update Properties.
	Properties any
}

var ApimapisAttachment = ubx.ResourceBinding{
