...
type ApimopenidconnectprovidersOpenidConnectProviderContract2_Properties struct {
...
type ApimopenidconnectprovidersOpenidConnectProviderContract2Attrs struct {
	// OpenID Connect Providers Contract.
	Properties any
	// path parameter, not part of the API's own resource representation
	Opid any
...
var ApimopenidconnectprovidersOpenidConnectProviderContract2 = ubx.ResourceBinding{
