...
type ApimworkspaceloggersLogger_Properties struct {
...
var ApimworkspaceloggersLogger_PropertiesFields = ubx.FieldMap{
...
type ApimworkspaceloggersLoggerConfig struct {
...
type ApimworkspaceloggersLoggerAttrs struct {
	// The Logger entity in API Management represents an event sink that you can use to log API Management events. Currently the Logger entity supports logging API Management events to Azure Event Hubs.
	Properties any
}

var ApimworkspaceloggersLogger = ubx.ResourceBinding{
