...
type ApimapisComment_Properties_WsdlSelector struct {
...
type ApimapisComment_Properties struct {
...
type ApimapisCommentConfig struct {
	// API Create or Update Properties.
	Properties any
}

type ApimapisCommentAttrs struct {
	// API Create or Update Properties.
	Properties any
}

var ApimapisComment = ubx.ResourceBinding{
