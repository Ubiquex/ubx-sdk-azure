...
type ApimapisSchema_Properties_WsdlSelector struct {
...
type ApimapisSchema_Properties struct {
...
type ApimapisSchemaConfig struct {
	// API Create or Update Properties.
	Properties any
}

type ApimapisSchemaAttrs struct {
	// API Create or Update Properties.
	Properties any
}

var ApimapisSchema = ubx.ResourceBinding{
